#!/usr/bin/env bash
# install/managemydamnlife-install.sh — Managemydamnlife
...
header_info "Managemydamnlife"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Managemydamnlife"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/managemydamnlife-install.sh"
...
echo ""
echo -e "${GR}Managemydamnlife installation complete!${NC}"
echo ""
