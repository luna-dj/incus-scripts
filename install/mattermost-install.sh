#!/usr/bin/env bash
# install/mattermost-install.sh — Mattermost
...
header_info "Mattermost"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Mattermost"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/mattermost-install.sh"
...
echo ""
echo -e "${GR}Mattermost installation complete!${NC}"
echo ""
