#!/usr/bin/env bash
# install/borg-ui-install.sh — Borg Ui
...
msg_info "Loading upstream install script for Borg Ui"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/borg-ui-install.sh"
...
echo ""
echo -e "${GR}Borg Ui installation complete!${NC}"
echo ""
