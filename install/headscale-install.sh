#!/usr/bin/env bash
# install/headscale-install.sh — Headscale
...
header_info "Headscale"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Headscale"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/headscale-install.sh"
...
echo ""
echo -e "${GR}Headscale installation complete!${NC}"
echo ""
