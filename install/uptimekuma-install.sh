#!/usr/bin/env bash
# install/uptimekuma-install.sh — Uptimekuma
...
header_info "Uptimekuma"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Uptimekuma"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/uptimekuma-install.sh"
...
echo ""
echo -e "${GR}Uptimekuma installation complete!${NC}"
echo ""
