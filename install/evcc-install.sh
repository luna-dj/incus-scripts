...
msg_info "Loading upstream install script for Evcc"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/evcc-install.sh"
...
echo ""
echo -e "${GR}Evcc installation complete!${NC}"
echo ""
