#!/usr/bin/env bash
# install/audiomuse-ai-install.sh — Audiomuse Ai
...
header_info "Audiomuse Ai"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Audiomuse Ai"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/audiomuse-ai-install.sh"
...
echo ""
echo -e "${GR}Audiomuse Ai installation complete!${NC}"
echo ""
