#!/usr/bin/env bash
# install/teable-install.sh — Teable
...
msg_info "Loading upstream install script for Teable"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/teable-install.sh"
...
echo ""
echo -e "${GR}Teable installation complete!${NC}"
echo ""
