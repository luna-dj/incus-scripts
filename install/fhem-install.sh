...
msg_info "Loading upstream install script for Fhem"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/fhem-install.sh"
...
echo ""
echo -e "${GR}Fhem installation complete!${NC}"
echo ""
