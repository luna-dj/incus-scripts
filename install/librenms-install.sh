#!/usr/bin/env bash
# install/librenms-install.sh — Librenms
...
header_info "Librenms"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Librenms"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/librenms-install.sh"
...
echo ""
echo -e "${GR}Librenms installation complete!${NC}"
echo ""
