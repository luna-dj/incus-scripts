#!/usr/bin/env bash
# install/alpine-ntfy-install.sh — Alpine Ntfy
...
header_info "Alpine Ntfy"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Ntfy"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-ntfy-install.sh"
...
echo ""
echo -e "${GR}Alpine Ntfy installation complete!${NC}"
echo ""
