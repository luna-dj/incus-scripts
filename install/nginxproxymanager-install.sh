#!/usr/bin/env bash
# install/nginxproxymanager-install.sh — Nginxproxymanager
...
header_info "Nginxproxymanager"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Nginxproxymanager"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/nginxproxymanager-install.sh"
