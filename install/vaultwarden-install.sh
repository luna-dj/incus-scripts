#!/usr/bin/env bash
# install/vaultwarden-install.sh — Vaultwarden
...
header_info "Vaultwarden"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Vaultwarden"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/vaultwarden-install.sh"
...
echo ""
echo -e "${GR}Vaultwarden installation complete!${NC}"
echo ""
