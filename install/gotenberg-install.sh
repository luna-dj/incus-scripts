#!/usr/bin/env bash
# install/gotenberg-install.sh — Gotenberg
...
header_info "Gotenberg"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Gotenberg"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/gotenberg-install.sh"
...
echo ""
echo -e "${GR}Gotenberg installation complete!${NC}"
echo ""
