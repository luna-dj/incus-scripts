#!/usr/bin/env bash
# install/ampache-install.sh — Ampache
...
msg_info "Loading upstream install script for Ampache"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/ampache-install.sh"
...
echo ""
echo -e "${GR}Ampache installation complete!${NC}"
echo ""
