#!/usr/bin/env bash
# install/cloudflared-install.sh — Cloudflared
...
header_info "Cloudflared"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Cloudflared"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/cloudflared-install.sh"
...
echo ""
echo -e "${GR}Cloudflared installation complete!${NC}"
echo ""
