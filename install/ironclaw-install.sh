#!/usr/bin/env bash
# install/ironclaw-install.sh — Ironclaw
...
header_info "Ironclaw"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Ironclaw"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/ironclaw-install.sh"
...
echo ""
echo -e "${GR}Ironclaw installation complete!${NC}"
echo ""
