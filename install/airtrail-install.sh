#!/usr/bin/env bash
# install/airtrail-install.sh — Airtrail
...
header_info "Airtrail"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Airtrail"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/airtrail-install.sh"
...
echo ""
echo -e "${GR}Airtrail installation complete!${NC}"
echo ""
