#!/usr/bin/env bash
# install/convertx-install.sh — Convertx
...
header_info "Convertx"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Convertx"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/convertx-install.sh"
...
echo ""
echo -e "${GR}Convertx installation complete!${NC}"
echo ""
