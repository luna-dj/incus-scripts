#!/usr/bin/env bash
# install/ghostfolio-install.sh — Ghostfolio
...
header_info "Ghostfolio"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Ghostfolio"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/ghostfolio-install.sh"
...
echo ""
echo -e "${GR}Ghostfolio installation complete!${NC}"
echo ""
