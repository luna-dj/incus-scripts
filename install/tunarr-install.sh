#!/usr/bin/env bash
# install/tunarr-install.sh — Tunarr
...
msg_info "Loading upstream install script for Tunarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/tunarr-install.sh"
...
echo ""
echo -e "${GR}Tunarr installation complete!${NC}"
echo ""
