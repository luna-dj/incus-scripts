#!/usr/bin/env bash
# install/suggestarr-install.sh — Suggestarr
...
header_info "Suggestarr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Suggestarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/suggestarr-install.sh"
...
echo ""
echo -e "${GR}Suggestarr installation complete!${NC}"
echo ""
