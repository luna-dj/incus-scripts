#!/usr/bin/env bash
# install/jenkins-install.sh — Jenkins
...
msg_info "Loading upstream install script for Jenkins"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/jenkins-install.sh"
...
echo ""
echo -e "${GR}Jenkins installation complete!${NC}"
echo ""
