#!/usr/bin/env bash
# install/part-db-install.sh — Part Db
...
msg_info "Loading upstream install script for Part Db"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/part-db-install.sh"
...
echo ""
echo -e "${GR}Part Db installation complete!${NC}"
echo ""
