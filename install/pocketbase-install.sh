#!/usr/bin/env bash
# install/pocketbase-install.sh — Pocketbase
...
header_info "Pocketbase"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Pocketbase"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/pocketbase-install.sh"
...
echo ""
echo -e "${GR}Pocketbase installation complete!${NC}"
echo ""
