#!/usr/bin/env bash
# install/metabase-install.sh — Metabase
...
header_info "Metabase"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Metabase"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/metabase-install.sh"
...
echo ""
echo -e "${GR}Metabase installation complete!${NC}"
echo ""
