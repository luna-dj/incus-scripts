#!/usr/bin/env bash
# install/apache-airflow-install.sh — Apache Airflow
...
header_info "Apache Airflow"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Apache Airflow"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/apache-airflow-install.sh"
...
echo ""
echo -e "${GR}Apache Airflow installation complete!${NC}"
echo ""
