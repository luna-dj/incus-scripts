#!/usr/bin/env bash
# install/planka-install.sh — Planka
...
msg_info "Loading upstream install script for Planka"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/planka-install.sh"
...
echo ""
echo -e "${GR}Planka installation complete!${NC}"
echo ""
