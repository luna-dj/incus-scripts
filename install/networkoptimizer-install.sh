#!/usr/bin/env bash
# install/networkoptimizer-install.sh — Networkoptimizer
...
header_info "Networkoptimizer"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Networkoptimizer"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/networkoptimizer-install.sh"
...
echo ""
echo -e "${GR}Networkoptimizer installation complete!${NC}"
echo ""
