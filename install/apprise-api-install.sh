#!/usr/bin/env bash
# install/apprise-api-install.sh — Apprise Api
...
header_info "Apprise Api"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Apprise Api"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/apprise-api-install.sh"
...
echo ""
echo -e "${GR}Apprise Api installation complete!${NC}"
echo ""
