#!/usr/bin/env bash
# install/docker-install.sh — Docker
...
msg_info "Loading upstream install script for Docker"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/docker-install.sh"
...
echo ""
echo -e "${GR}Docker installation complete!${NC}"
echo ""
