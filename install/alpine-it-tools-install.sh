#!/usr/bin/env bash
# install/alpine-it-tools-install.sh — Alpine It Tools
...
header_info "Alpine It Tools"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine It Tools"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-it-tools-install.sh"
...
echo ""
echo -e "${GR}Alpine It Tools installation complete!${NC}"
echo ""
