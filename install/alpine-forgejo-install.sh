#!/usr/bin/env bash
# install/alpine-forgejo-install.sh — Alpine Forgejo
...
header_info "Alpine Forgejo"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Forgejo"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-forgejo-install.sh"
...
echo ""
echo -e "${GR}Alpine Forgejo installation complete!${NC}"
echo ""
