#!/usr/bin/env bash
# install/zerobyte-install.sh — Zerobyte
...
header_info "Zerobyte"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Zerobyte"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/zerobyte-install.sh"
...
echo ""
echo -e "${GR}Zerobyte installation complete!${NC}"
echo ""
