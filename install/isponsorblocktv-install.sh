#!/usr/bin/env bash
# install/isponsorblocktv-install.sh — Isponsorblocktv
...
header_info "Isponsorblocktv"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Isponsorblocktv"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/isponsorblocktv-install.sh"
...
echo ""
echo -e "${GR}Isponsorblocktv installation complete!${NC}"
echo ""
