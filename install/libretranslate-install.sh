#!/usr/bin/env bash
# install/libretranslate-install.sh — Libretranslate
...
header_info "Libretranslate"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Libretranslate"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/libretranslate-install.sh"
...
echo ""
echo -e "${GR}Libretranslate installation complete!${NC}"
echo ""
