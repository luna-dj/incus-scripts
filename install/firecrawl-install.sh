#!/usr/bin/env bash
# install/firecrawl-install.sh — Firecrawl
...
header_info "Firecrawl"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Firecrawl"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/firecrawl-install.sh"
...
echo ""
echo -e "${GR}Firecrawl installation complete!${NC}"
echo ""
