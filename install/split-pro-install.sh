#!/usr/bin/env bash
# install/split-pro-install.sh — Split Pro
...
header_info "Split Pro"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Split Pro"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/split-pro-install.sh"
...
echo ""
echo -e "${GR}Split Pro installation complete!${NC}"
echo ""
