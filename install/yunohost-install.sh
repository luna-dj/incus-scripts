#!/usr/bin/env bash
# install/yunohost-install.sh — Yunohost
...
header_info "Yunohost"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Yunohost"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/yunohost-install.sh"
...
echo ""
echo -e "${GR}Yunohost installation complete!${NC}"
echo ""
