#!/usr/bin/env bash
# install/unmanic-install.sh — Unmanic
...
msg_info "Loading upstream install script for Unmanic"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/unmanic-install.sh"
...
echo ""
echo -e "${GR}Unmanic installation complete!${NC}"
echo ""
