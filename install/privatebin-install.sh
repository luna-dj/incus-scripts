#!/usr/bin/env bash
# install/privatebin-install.sh — Privatebin
...
header_info "Privatebin"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Privatebin"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/privatebin-install.sh"
...
echo ""
echo -e "${GR}Privatebin installation complete!${NC}"
echo ""
