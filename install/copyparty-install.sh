#!/usr/bin/env bash
# install/copyparty-install.sh — Copyparty (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Copyparty addon)"
  setup_docker
  msg_ok "Docker installed"
fi

msg_info "Loading upstream addon script for Copyparty"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/copyparty.sh"
...
echo ""
echo -e "${GR}Copyparty installation complete!${NC}"
echo ""
