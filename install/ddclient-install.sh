#!/usr/bin/env bash
# install/ddclient-install.sh — Ddclient
...
header_info "Ddclient"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Ddclient"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/ddclient-install.sh"
...
echo ""
echo -e "${GR}Ddclient installation complete!${NC}"
echo ""
