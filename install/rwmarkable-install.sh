#!/usr/bin/env bash
# install/rwmarkable-install.sh — Rwmarkable
...
header_info "Rwmarkable"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Rwmarkable"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/rwmarkable-install.sh"
...
echo ""
echo -e "${GR}Rwmarkable installation complete!${NC}"
echo ""
