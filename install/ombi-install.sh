...
msg_info "Loading upstream install script for Ombi"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/ombi-install.sh"
...
echo ""
echo -e "${GR}Ombi installation complete!${NC}"
echo ""
