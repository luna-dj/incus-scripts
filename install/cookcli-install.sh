#!/usr/bin/env bash
# install/cookcli-install.sh — Cookcli
...
msg_info "Loading upstream install script for Cookcli"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/cookcli-install.sh"
...
echo ""
echo -e "${GR}Cookcli installation complete!${NC}"
echo ""
