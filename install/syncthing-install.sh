#!/usr/bin/env bash
# install/syncthing-install.sh — Syncthing
...
header_info "Syncthing"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Syncthing"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/syncthing-install.sh"
...
echo ""
echo -e "${GR}Syncthing installation complete!${NC}"
echo ""
