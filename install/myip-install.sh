...
msg_info "Loading upstream install script for Myip"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/myip-install.sh"
...
echo ""
echo -e "${GR}Myip installation complete!${NC}"
echo ""
