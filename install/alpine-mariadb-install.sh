#!/usr/bin/env bash
# install/alpine-mariadb-install.sh — Alpine Mariadb
...
header_info "Alpine Mariadb"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Mariadb"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-mariadb-install.sh"
...
echo ""
echo -e "${GR}Alpine Mariadb installation complete!${NC}"
echo ""
