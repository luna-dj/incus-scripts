#!/usr/bin/env bash
# install/openthread-br-install.sh — Openthread Br
...
header_info "Openthread Br"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Openthread Br"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/openthread-br-install.sh"
...
echo ""
echo -e "${GR}Openthread Br installation complete!${NC}"
echo ""
