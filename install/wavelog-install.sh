#!/usr/bin/env bash
# install/wavelog-install.sh — Wavelog
...
msg_info "Loading upstream install script for Wavelog"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/wavelog-install.sh"
...
echo ""
echo -e "${GR}Wavelog installation complete!${NC}"
echo ""
