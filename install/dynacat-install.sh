#!/usr/bin/env bash
# install/dynacat-install.sh — Dynacat
...
msg_info "Loading upstream install script for Dynacat"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/dynacat-install.sh"
...
echo ""
echo -e "${GR}Dynacat installation complete!${NC}"
echo ""
