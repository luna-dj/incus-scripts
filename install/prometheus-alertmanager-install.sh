#!/usr/bin/env bash
# install/prometheus-alertmanager-install.sh — Prometheus Alertmanager
...
header_info "Prometheus Alertmanager"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Prometheus Alertmanager"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/prometheus-alertmanager-install.sh"
...
echo ""
echo -e "${GR}Prometheus Alertmanager installation complete!${NC}"
echo ""
