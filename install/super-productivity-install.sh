#!/usr/bin/env bash
# install/super-productivity-install.sh — Super Productivity
...
header_info "Super Productivity"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Super Productivity"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/super-productivity-install.sh"
...
echo ""
echo -e "${GR}Super Productivity installation complete!${NC}"
echo ""
