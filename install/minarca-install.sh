#!/usr/bin/env bash
# install/minarca-install.sh — Minarca
...
msg_info "Loading upstream install script for Minarca"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/minarca-install.sh"
...
echo ""
echo -e "${GR}Minarca installation complete!${NC}"
echo ""
