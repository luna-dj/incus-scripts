#!/usr/bin/env bash
# install/podman-install.sh — Podman
...
msg_info "Loading upstream install script for Podman"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/podman-install.sh"
...
echo ""
echo -e "${GR}Podman installation complete!${NC}"
echo ""
