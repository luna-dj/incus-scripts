#!/usr/bin/env bash
# install/certimate-install.sh — Certimate
...
header_info "Certimate"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Certimate"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/certimate-install.sh"
...
echo ""
echo -e "${GR}Certimate installation complete!${NC}"
echo ""
