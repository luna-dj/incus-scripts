#!/usr/bin/env bash
# install/agentdvr-install.sh — Agentdvr
...
header_info "Agentdvr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Agentdvr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/agentdvr-install.sh"
...
echo ""
echo -e "${GR}Agentdvr installation complete!${NC}"
echo ""
