#!/usr/bin/env bash
# install/keycloak-install.sh — Keycloak
...
header_info "Keycloak"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Keycloak"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/keycloak-install.sh"
...
echo ""
echo -e "${GR}Keycloak installation complete!${NC}"
echo ""
