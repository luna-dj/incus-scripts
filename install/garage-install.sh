#!/usr/bin/env bash
# install/garage-install.sh — Garage
...
msg_info "Loading upstream install script for Garage"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/garage-install.sh"
...
echo ""
echo -e "${GR}Garage installation complete!${NC}"
echo ""
