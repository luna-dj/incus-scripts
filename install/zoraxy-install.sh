#!/usr/bin/env bash
# install/zoraxy-install.sh — Zoraxy
...
msg_info "Loading upstream install script for Zoraxy"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/zoraxy-install.sh"
...
echo ""
echo -e "${GR}Zoraxy installation complete!${NC}"
echo ""
