#!/usr/bin/env bash
# install/linkding-install.sh — Linkding
...
header_info "Linkding"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Linkding"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/linkding-install.sh"
...
echo ""
echo -e "${GR}Linkding installation complete!${NC}"
echo ""
