#!/usr/bin/env bash
# install/smokeping-install.sh — Smokeping
...
header_info "Smokeping"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Smokeping"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/smokeping-install.sh"
...
echo ""
echo -e "${GR}Smokeping installation complete!${NC}"
echo ""
