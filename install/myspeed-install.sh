#!/usr/bin/env bash
# install/myspeed-install.sh — Myspeed
...
msg_info "Loading upstream install script for Myspeed"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/myspeed-install.sh"
...
echo ""
echo -e "${GR}Myspeed installation complete!${NC}"
echo ""
