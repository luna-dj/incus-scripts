#!/usr/bin/env bash
# install/booklore-install.sh — Booklore
...
header_info "Booklore"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Booklore"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/booklore-install.sh"
...
echo ""
echo -e "${GR}Booklore installation complete!${NC}"
echo ""
