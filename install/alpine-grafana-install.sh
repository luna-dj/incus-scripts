#!/usr/bin/env bash
# install/alpine-grafana-install.sh — Alpine Grafana
...
header_info "Alpine Grafana"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Grafana"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-grafana-install.sh"
...
echo ""
echo -e "${GR}Alpine Grafana installation complete!${NC}"
echo ""
