#!/usr/bin/env bash
# install/beszel-install.sh — Beszel
...
msg_info "Loading upstream install script for Beszel"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/beszel-install.sh"
...
echo ""
echo -e "${GR}Beszel installation complete!${NC}"
echo ""
