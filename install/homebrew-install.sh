#!/usr/bin/env bash
# install/homebrew-install.sh — Homebrew (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Homebrew addon)"
  setup_docker
  msg_ok "Docker installed"
fi

msg_info "Loading upstream addon script for Homebrew"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/homebrew.sh"
...
echo ""
echo -e "${GR}Homebrew installation complete!${NC}"
echo ""
