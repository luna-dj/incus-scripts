#!/usr/bin/env bash
# install/pinchflat-install.sh — Pinchflat
...
header_info "Pinchflat"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Pinchflat"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/pinchflat-install.sh"
...
echo ""
echo -e "${GR}Pinchflat installation complete!${NC}"
echo ""
