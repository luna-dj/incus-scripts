#!/usr/bin/env bash
# install/apt-cacher-ng-install.sh — Apt Cacher Ng
...
header_info "Apt Cacher Ng"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Apt Cacher Ng"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/apt-cacher-ng-install.sh"
...
echo ""
echo -e "${GR}Apt Cacher Ng installation complete!${NC}"
echo ""
