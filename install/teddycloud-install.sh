#!/usr/bin/env bash
# install/teddycloud-install.sh — Teddycloud
...
header_info "Teddycloud"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Teddycloud"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/teddycloud-install.sh"
...
echo ""
echo -e "${GR}Teddycloud installation complete!${NC}"
echo ""
