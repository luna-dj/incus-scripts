#!/usr/bin/env bash
# install/asterisk-install.sh — Asterisk
...
header_info "Asterisk"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Asterisk"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/asterisk-install.sh"
...
echo ""
echo -e "${GR}Asterisk installation complete!${NC}"
echo ""
