#!/usr/bin/env bash
# install/portainer-install.sh — Portainer (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Portainer addon)"
  setup_docker
...
msg_info "Loading upstream addon script for Portainer"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/portainer.sh"
...
echo ""
echo -e "${GR}Portainer installation complete!${NC}"
echo ""
