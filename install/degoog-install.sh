#!/usr/bin/env bash
# install/degoog-install.sh — Degoog
...
msg_info "Loading upstream install script for Degoog"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/degoog-install.sh"
...
echo ""
echo -e "${GR}Degoog installation complete!${NC}"
echo ""
