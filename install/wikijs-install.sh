#!/usr/bin/env bash
# install/wikijs-install.sh — Wikijs
...
msg_info "Loading upstream install script for Wikijs"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/wikijs-install.sh"
...
echo ""
echo -e "${GR}Wikijs installation complete!${NC}"
echo ""
