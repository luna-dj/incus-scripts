#!/usr/bin/env bash
# install/alpine-caddy-install.sh — Alpine Caddy
...
header_info "Alpine Caddy"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Caddy"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-caddy-install.sh"
...
echo ""
echo -e "${GR}Alpine Caddy installation complete!${NC}"
echo ""
