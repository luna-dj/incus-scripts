#!/usr/bin/env bash
# install/sonobarr-install.sh — Sonobarr
...
header_info "Sonobarr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Sonobarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/sonobarr-install.sh"
...
echo ""
echo -e "${GR}Sonobarr installation complete!${NC}"
echo ""
