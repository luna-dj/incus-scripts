#!/usr/bin/env bash
# install/victoriametrics-install.sh — Victoriametrics
...
header_info "Victoriametrics"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Victoriametrics"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/victoriametrics-install.sh"
...
echo ""
echo -e "${GR}Victoriametrics installation complete!${NC}"
echo ""
