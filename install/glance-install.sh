#!/usr/bin/env bash
# install/glance-install.sh — Glance
...
msg_info "Loading upstream install script for Glance"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/glance-install.sh"
...
echo ""
echo -e "${GR}Glance installation complete!${NC}"
echo ""
