...
msg_info "Loading upstream install script for Emby"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/emby-install.sh"
...
echo ""
echo -e "${GR}Emby installation complete!${NC}"
echo ""
