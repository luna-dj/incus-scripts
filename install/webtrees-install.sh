#!/usr/bin/env bash
# install/webtrees-install.sh — Webtrees
...
header_info "Webtrees"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Webtrees"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/webtrees-install.sh"
...
echo ""
echo -e "${GR}Webtrees installation complete!${NC}"
echo ""
