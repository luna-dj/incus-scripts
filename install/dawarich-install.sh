#!/usr/bin/env bash
# install/dawarich-install.sh — Dawarich
...
header_info "Dawarich"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Dawarich"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/dawarich-install.sh"
...
echo ""
echo -e "${GR}Dawarich installation complete!${NC}"
echo ""
