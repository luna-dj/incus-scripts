#!/usr/bin/env bash
# install/peanut-install.sh — Peanut
...
msg_info "Loading upstream install script for Peanut"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/peanut-install.sh"
...
echo ""
echo -e "${GR}Peanut installation complete!${NC}"
echo ""
