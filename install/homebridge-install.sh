#!/usr/bin/env bash
# install/homebridge-install.sh — Homebridge
...
header_info "Homebridge"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Homebridge"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/homebridge-install.sh"
...
echo ""
echo -e "${GR}Homebridge installation complete!${NC}"
echo ""
