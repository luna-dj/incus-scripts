#!/usr/bin/env bash
# install/ollama-install.sh — Ollama
...
msg_info "Loading upstream install script for Ollama"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/ollama-install.sh"
...
echo ""
echo -e "${GR}Ollama installation complete!${NC}"
echo ""
