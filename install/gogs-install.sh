...
msg_info "Loading upstream install script for Gogs"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/gogs-install.sh"
...
echo ""
echo -e "${GR}Gogs installation complete!${NC}"
echo ""
