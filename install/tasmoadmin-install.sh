#!/usr/bin/env bash
# install/tasmoadmin-install.sh — Tasmoadmin
...
header_info "Tasmoadmin"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Tasmoadmin"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/tasmoadmin-install.sh"
...
echo ""
echo -e "${GR}Tasmoadmin installation complete!${NC}"
echo ""
