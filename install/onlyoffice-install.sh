#!/usr/bin/env bash
# install/onlyoffice-install.sh — Onlyoffice
...
header_info "Onlyoffice"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Onlyoffice"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/onlyoffice-install.sh"
...
echo ""
echo -e "${GR}Onlyoffice installation complete!${NC}"
echo ""
