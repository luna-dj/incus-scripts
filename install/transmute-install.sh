#!/usr/bin/env bash
# install/transmute-install.sh — Transmute
...
header_info "Transmute"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Transmute"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/transmute-install.sh"
...
echo ""
echo -e "${GR}Transmute installation complete!${NC}"
echo ""
