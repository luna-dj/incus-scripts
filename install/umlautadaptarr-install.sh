#!/usr/bin/env bash
# install/umlautadaptarr-install.sh — Umlautadaptarr
...
header_info "Umlautadaptarr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Umlautadaptarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/umlautadaptarr-install.sh"
...
echo ""
echo -e "${GR}Umlautadaptarr installation complete!${NC}"
echo ""
