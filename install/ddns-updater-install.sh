#!/usr/bin/env bash
# install/ddns-updater-install.sh — Ddns Updater
...
header_info "Ddns Updater"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Ddns Updater"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/ddns-updater-install.sh"
...
echo ""
echo -e "${GR}Ddns Updater installation complete!${NC}"
echo ""
