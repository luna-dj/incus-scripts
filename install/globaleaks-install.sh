#!/usr/bin/env bash
# install/globaleaks-install.sh — Globaleaks
...
header_info "Globaleaks"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Globaleaks"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/globaleaks-install.sh"
...
echo ""
echo -e "${GR}Globaleaks installation complete!${NC}"
echo ""
