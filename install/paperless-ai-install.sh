#!/usr/bin/env bash
# install/paperless-ai-install.sh — Paperless Ai
...
header_info "Paperless Ai"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Paperless Ai"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/paperless-ai-install.sh"
...
echo ""
echo -e "${GR}Paperless Ai installation complete!${NC}"
echo ""
