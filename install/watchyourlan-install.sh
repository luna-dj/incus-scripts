#!/usr/bin/env bash
# install/watchyourlan-install.sh — Watchyourlan
...
header_info "Watchyourlan"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Watchyourlan"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/watchyourlan-install.sh"
...
echo ""
echo -e "${GR}Watchyourlan installation complete!${NC}"
echo ""
