#!/usr/bin/env bash
# install/alpine-nextcloud-install.sh — Alpine Nextcloud
...
header_info "Alpine Nextcloud"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Nextcloud"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-nextcloud-install.sh"
...
echo ""
echo -e "${GR}Alpine Nextcloud installation complete!${NC}"
echo ""
