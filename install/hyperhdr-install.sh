#!/usr/bin/env bash
# install/hyperhdr-install.sh — Hyperhdr
...
header_info "Hyperhdr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Hyperhdr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/hyperhdr-install.sh"
...
echo ""
echo -e "${GR}Hyperhdr installation complete!${NC}"
echo ""
