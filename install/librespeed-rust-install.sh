#!/usr/bin/env bash
# install/librespeed-rust-install.sh — Librespeed Rust
...
header_info "Librespeed Rust"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Librespeed Rust"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/librespeed-rust-install.sh"
...
echo ""
echo -e "${GR}Librespeed Rust installation complete!${NC}"
echo ""
