#!/usr/bin/env bash
# install/matter-server-install.sh — Matter Server
...
header_info "Matter Server"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Matter Server"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/matter-server-install.sh"
...
echo ""
echo -e "${GR}Matter Server installation complete!${NC}"
echo ""
