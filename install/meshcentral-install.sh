#!/usr/bin/env bash
# install/meshcentral-install.sh — Meshcentral
...
header_info "Meshcentral"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Meshcentral"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/meshcentral-install.sh"
...
echo ""
echo -e "${GR}Meshcentral installation complete!${NC}"
echo ""
