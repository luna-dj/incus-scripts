#!/usr/bin/env bash
# install/tubearchivist-install.sh — Tubearchivist
...
header_info "Tubearchivist"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Tubearchivist"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/tubearchivist-install.sh"
...
echo ""
echo -e "${GR}Tubearchivist installation complete!${NC}"
echo ""
