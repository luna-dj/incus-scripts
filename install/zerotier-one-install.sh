#!/usr/bin/env bash
# install/zerotier-one-install.sh — Zerotier One
...
header_info "Zerotier One"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Zerotier One"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/zerotier-one-install.sh"
...
echo ""
echo -e "${GR}Zerotier One installation complete!${NC}"
echo ""
