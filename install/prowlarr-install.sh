#!/usr/bin/env bash
# install/prowlarr-install.sh — Prowlarr
...
header_info "Prowlarr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Prowlarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/prowlarr-install.sh"
...
echo ""
echo -e "${GR}Prowlarr installation complete!${NC}"
echo ""
