#!/usr/bin/env bash
# install/igotify-install.sh — Igotify
...
msg_info "Loading upstream install script for Igotify"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/igotify-install.sh"
...
echo ""
echo -e "${GR}Igotify installation complete!${NC}"
echo ""
