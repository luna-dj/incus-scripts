#!/usr/bin/env bash
# install/crafty-controller-install.sh — Crafty Controller
...
header_info "Crafty Controller"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Crafty Controller"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/crafty-controller-install.sh"
...
echo ""
echo -e "${GR}Crafty Controller installation complete!${NC}"
echo ""
