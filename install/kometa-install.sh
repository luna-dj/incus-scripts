#!/usr/bin/env bash
# install/kometa-install.sh — Kometa
...
msg_info "Loading upstream install script for Kometa"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/kometa-install.sh"
...
echo ""
echo -e "${GR}Kometa installation complete!${NC}"
echo ""
