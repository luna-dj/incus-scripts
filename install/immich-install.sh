#!/usr/bin/env bash
# install/immich-install.sh — Immich
...
msg_info "Loading upstream install script for Immich"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/immich-install.sh"
...
echo ""
echo -e "${GR}Immich installation complete!${NC}"
echo ""
