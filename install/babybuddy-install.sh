#!/usr/bin/env bash
# install/babybuddy-install.sh — Babybuddy
...
header_info "Babybuddy"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Babybuddy"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/babybuddy-install.sh"
...
echo ""
echo -e "${GR}Babybuddy installation complete!${NC}"
echo ""
