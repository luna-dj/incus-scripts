...
msg_info "Loading upstream install script for Kasm"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/kasm-install.sh"
...
echo ""
echo -e "${GR}Kasm installation complete!${NC}"
echo ""
