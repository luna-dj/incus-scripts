#!/usr/bin/env bash
# install/storyteller-install.sh — Storyteller
...
header_info "Storyteller"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Storyteller"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/storyteller-install.sh"
...
echo ""
echo -e "${GR}Storyteller installation complete!${NC}"
echo ""
