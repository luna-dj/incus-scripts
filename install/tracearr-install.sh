#!/usr/bin/env bash
# install/tracearr-install.sh — Tracearr
...
header_info "Tracearr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Tracearr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/tracearr-install.sh"
...
echo ""
echo -e "${GR}Tracearr installation complete!${NC}"
echo ""
