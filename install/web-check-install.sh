#!/usr/bin/env bash
# install/web-check-install.sh — Web Check
...
header_info "Web Check"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Web Check"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/web-check-install.sh"
...
echo ""
echo -e "${GR}Web Check installation complete!${NC}"
echo ""
