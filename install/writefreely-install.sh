#!/usr/bin/env bash
# install/writefreely-install.sh — Writefreely
...
header_info "Writefreely"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Writefreely"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/writefreely-install.sh"
...
echo ""
echo -e "${GR}Writefreely installation complete!${NC}"
echo ""
