#!/usr/bin/env bash
# install/readeck-install.sh — Readeck
...
msg_info "Loading upstream install script for Readeck"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/readeck-install.sh"
...
echo ""
echo -e "${GR}Readeck installation complete!${NC}"
echo ""
