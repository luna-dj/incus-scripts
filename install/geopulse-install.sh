#!/usr/bin/env bash
# install/geopulse-install.sh — Geopulse
...
header_info "Geopulse"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Geopulse"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/geopulse-install.sh"
...
echo ""
echo -e "${GR}Geopulse installation complete!${NC}"
echo ""
