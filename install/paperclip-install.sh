#!/usr/bin/env bash
# install/paperclip-install.sh — Paperclip
...
header_info "Paperclip"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Paperclip"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/paperclip-install.sh"
...
echo ""
echo -e "${GR}Paperclip installation complete!${NC}"
echo ""
