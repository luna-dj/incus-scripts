#!/usr/bin/env bash
# install/dockge-install.sh — Dockge (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Dockge addon)"
  setup_docker
...
msg_info "Loading upstream addon script for Dockge"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/dockge.sh"
...
echo ""
echo -e "${GR}Dockge installation complete!${NC}"
echo ""
