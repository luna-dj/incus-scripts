#!/usr/bin/env bash
# install/dockge-install.sh — Dockge
...
msg_info "Loading upstream install script for Dockge"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/dockge-install.sh"
