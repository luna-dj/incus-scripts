#!/usr/bin/env bash
# install/all-templates-install.sh — All Templates (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for All Templates addon)"
  setup_docker
...
msg_info "Loading upstream addon script for All Templates"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/all-templates.sh"
...
echo ""
echo -e "${GR}All Templates installation complete!${NC}"
echo ""
