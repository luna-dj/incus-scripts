#!/usr/bin/env bash
# install/seaweedfs-install.sh — Seaweedfs
...
header_info "Seaweedfs"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Seaweedfs"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/seaweedfs-install.sh"
...
echo ""
echo -e "${GR}Seaweedfs installation complete!${NC}"
echo ""
