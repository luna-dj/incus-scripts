#!/usr/bin/env bash
# install/zabbix-install.sh — Zabbix
...
msg_info "Loading upstream install script for Zabbix"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/zabbix-install.sh"
...
echo ""
echo -e "${GR}Zabbix installation complete!${NC}"
echo ""
