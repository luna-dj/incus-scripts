#!/usr/bin/env bash
# install/freshrss-install.sh — Freshrss
...
header_info "Freshrss"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Freshrss"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/freshrss-install.sh"
...
echo ""
echo -e "${GR}Freshrss installation complete!${NC}"
echo ""
