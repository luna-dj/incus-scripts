#!/usr/bin/env bash
# install/gitea-mirror-install.sh — Gitea Mirror
...
header_info "Gitea Mirror"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Gitea Mirror"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/gitea-mirror-install.sh"
...
echo ""
echo -e "${GR}Gitea Mirror installation complete!${NC}"
echo ""
