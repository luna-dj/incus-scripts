#!/usr/bin/env bash
# install/snipeit-install.sh — Snipeit
...
msg_info "Loading upstream install script for Snipeit"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/snipeit-install.sh"
...
echo ""
echo -e "${GR}Snipeit installation complete!${NC}"
echo ""
