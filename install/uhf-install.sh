...
msg_info "Loading upstream install script for Uhf"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/uhf-install.sh"
...
echo ""
echo -e "${GR}Uhf installation complete!${NC}"
echo ""
