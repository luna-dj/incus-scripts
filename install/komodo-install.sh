#!/usr/bin/env bash
# install/komodo-install.sh — Komodo (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Komodo addon)"
  setup_docker
...
msg_info "Loading upstream addon script for Komodo"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/komodo.sh"
...
echo ""
echo -e "${GR}Komodo installation complete!${NC}"
echo ""
