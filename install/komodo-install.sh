#!/usr/bin/env bash
# install/komodo-install.sh — Komodo
...
msg_info "Loading upstream install script for Komodo"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/komodo-install.sh"
