#!/usr/bin/env bash
# install/reactive-resume-install.sh — Reactive Resume
...
header_info "Reactive Resume"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Reactive Resume"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/reactive-resume-install.sh"
...
echo ""
echo -e "${GR}Reactive Resume installation complete!${NC}"
echo ""
