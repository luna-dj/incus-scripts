#!/usr/bin/env bash
# install/sonarr-install.sh — Sonarr
...
msg_info "Loading upstream install script for Sonarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/sonarr-install.sh"
...
echo ""
echo -e "${GR}Sonarr installation complete!${NC}"
echo ""
