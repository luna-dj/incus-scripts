#!/usr/bin/env bash
# install/aurral-install.sh — Aurral
...
msg_info "Loading upstream install script for Aurral"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/aurral-install.sh"
...
echo ""
echo -e "${GR}Aurral installation complete!${NC}"
echo ""
