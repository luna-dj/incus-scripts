#!/usr/bin/env bash
# install/nexterm-install.sh — Nexterm
...
msg_info "Loading upstream install script for Nexterm"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/nexterm-install.sh"
...
echo ""
echo -e "${GR}Nexterm installation complete!${NC}"
echo ""
