#!/usr/bin/env bash
# install/prometheus-blackbox-exporter-install.sh — Prometheus Blackbox Exporter
...
header_info "Prometheus Blackbox Exporter"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Prometheus Blackbox Exporter"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/prometheus-blackbox-exporter-install.sh"
...
echo ""
echo -e "${GR}Prometheus Blackbox Exporter installation complete!${NC}"
echo ""
