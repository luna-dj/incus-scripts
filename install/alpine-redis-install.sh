#!/usr/bin/env bash
# install/alpine-redis-install.sh — Alpine Redis
...
header_info "Alpine Redis"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Redis"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-redis-install.sh"
...
echo ""
echo -e "${GR}Alpine Redis installation complete!${NC}"
echo ""
