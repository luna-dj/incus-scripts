#!/usr/bin/env bash
# install/esphome-install.sh — Esphome
...
msg_info "Loading upstream install script for Esphome"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/esphome-install.sh"
...
echo ""
echo -e "${GR}Esphome installation complete!${NC}"
echo ""
