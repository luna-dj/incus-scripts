#!/usr/bin/env bash
# install/ezbookkeeping-install.sh — Ezbookkeeping
...
header_info "Ezbookkeeping"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Ezbookkeeping"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/ezbookkeeping-install.sh"
...
echo ""
echo -e "${GR}Ezbookkeeping installation complete!${NC}"
echo ""
