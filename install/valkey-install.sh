#!/usr/bin/env bash
# install/valkey-install.sh — Valkey
...
msg_info "Loading upstream install script for Valkey"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/valkey-install.sh"
...
echo ""
echo -e "${GR}Valkey installation complete!${NC}"
echo ""
