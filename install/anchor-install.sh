#!/usr/bin/env bash
# install/anchor-install.sh — Anchor
...
msg_info "Loading upstream install script for Anchor"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/anchor-install.sh"
...
echo ""
echo -e "${GR}Anchor installation complete!${NC}"
echo ""
