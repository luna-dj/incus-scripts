#!/usr/bin/env bash
# install/sqlserver2025-install.sh — Sqlserver2025
...
header_info "Sqlserver2025"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Sqlserver2025"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/sqlserver2025-install.sh"
...
echo ""
echo -e "${GR}Sqlserver2025 installation complete!${NC}"
echo ""
