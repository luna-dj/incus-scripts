#!/usr/bin/env bash
# install/twenty-install.sh — Twenty
...
msg_info "Loading upstream install script for Twenty"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/twenty-install.sh"
...
echo ""
echo -e "${GR}Twenty installation complete!${NC}"
echo ""
