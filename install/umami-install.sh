#!/usr/bin/env bash
# install/umami-install.sh — Umami
...
msg_info "Loading upstream install script for Umami"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/umami-install.sh"
...
echo ""
echo -e "${GR}Umami installation complete!${NC}"
echo ""
