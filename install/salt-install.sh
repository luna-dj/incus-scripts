...
msg_info "Loading upstream install script for Salt"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/salt-install.sh"
...
echo ""
echo -e "${GR}Salt installation complete!${NC}"
echo ""
