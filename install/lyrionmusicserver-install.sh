#!/usr/bin/env bash
# install/lyrionmusicserver-install.sh — Lyrionmusicserver
...
header_info "Lyrionmusicserver"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Lyrionmusicserver"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/lyrionmusicserver-install.sh"
...
echo ""
echo -e "${GR}Lyrionmusicserver installation complete!${NC}"
echo ""
