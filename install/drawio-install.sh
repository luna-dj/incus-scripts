#!/usr/bin/env bash
# install/drawio-install.sh — Drawio
...
msg_info "Loading upstream install script for Drawio"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/drawio-install.sh"
...
echo ""
echo -e "${GR}Drawio installation complete!${NC}"
echo ""
