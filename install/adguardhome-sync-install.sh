#!/usr/bin/env bash
# install/adguardhome-sync-install.sh — Adguardhome Sync (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Adguardhome Sync addon)"
  setup_docker
...
msg_info "Loading upstream addon script for Adguardhome Sync"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/adguardhome-sync.sh"
...
echo ""
echo -e "${GR}Adguardhome Sync installation complete!${NC}"
echo ""
