#!/usr/bin/env bash
# install/gluetun-install.sh — Gluetun
...
msg_info "Loading upstream install script for Gluetun"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/gluetun-install.sh"
...
echo ""
echo -e "${GR}Gluetun installation complete!${NC}"
echo ""
