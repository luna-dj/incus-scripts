#!/usr/bin/env bash
# install/storybook-install.sh — Storybook
...
header_info "Storybook"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Storybook"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/storybook-install.sh"
...
echo ""
echo -e "${GR}Storybook installation complete!${NC}"
echo ""
