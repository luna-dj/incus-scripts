#!/usr/bin/env bash
# install/argus-install.sh — Argus
...
msg_info "Loading upstream install script for Argus"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/argus-install.sh"
...
echo ""
echo -e "${GR}Argus installation complete!${NC}"
echo ""
