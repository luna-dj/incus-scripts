#!/usr/bin/env bash
# install/oauth2-proxy-install.sh — Oauth2 Proxy
...
header_info "Oauth2 Proxy"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Oauth2 Proxy"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/oauth2-proxy-install.sh"
...
echo ""
echo -e "${GR}Oauth2 Proxy installation complete!${NC}"
echo ""
