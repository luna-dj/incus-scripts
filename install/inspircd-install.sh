#!/usr/bin/env bash
# install/inspircd-install.sh — Inspircd
...
header_info "Inspircd"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Inspircd"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/inspircd-install.sh"
...
echo ""
echo -e "${GR}Inspircd installation complete!${NC}"
echo ""
