#!/usr/bin/env bash
# install/apache-couchdb-install.sh — Apache Couchdb
...
header_info "Apache Couchdb"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Apache Couchdb"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/apache-couchdb-install.sh"
...
echo ""
echo -e "${GR}Apache Couchdb installation complete!${NC}"
echo ""
