#!/usr/bin/env bash
# install/coolify-install.sh — Coolify (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Coolify addon)"
  setup_docker
  msg_ok "Docker installed"
fi

msg_info "Loading upstream addon script for Coolify"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/coolify.sh"
...
echo ""
echo -e "${GR}Coolify installation complete!${NC}"
echo ""
