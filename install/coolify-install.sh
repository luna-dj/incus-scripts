#!/usr/bin/env bash
# install/coolify-install.sh — Coolify
...
msg_info "Loading upstream install script for Coolify"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/coolify-install.sh"
