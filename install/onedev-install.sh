#!/usr/bin/env bash
# install/onedev-install.sh — Onedev
...
msg_info "Loading upstream install script for Onedev"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/onedev-install.sh"
...
echo ""
echo -e "${GR}Onedev installation complete!${NC}"
echo ""
