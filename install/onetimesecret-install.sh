#!/usr/bin/env bash
# install/onetimesecret-install.sh — Onetimesecret
...
header_info "Onetimesecret"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Onetimesecret"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/onetimesecret-install.sh"
...
echo ""
echo -e "${GR}Onetimesecret installation complete!${NC}"
echo ""
