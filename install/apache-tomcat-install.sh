#!/usr/bin/env bash
# install/apache-tomcat-install.sh — Apache Tomcat
...
header_info "Apache Tomcat"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Apache Tomcat"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/apache-tomcat-install.sh"
...
echo ""
echo -e "${GR}Apache Tomcat installation complete!${NC}"
echo ""
