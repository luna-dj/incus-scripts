#!/usr/bin/env bash
# install/fluid-calendar-install.sh — Fluid Calendar
...
header_info "Fluid Calendar"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Fluid Calendar"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/fluid-calendar-install.sh"
...
echo ""
echo -e "${GR}Fluid Calendar installation complete!${NC}"
echo ""
