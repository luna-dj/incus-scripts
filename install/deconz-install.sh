#!/usr/bin/env bash
# install/deconz-install.sh — Deconz
...
msg_info "Loading upstream install script for Deconz"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/deconz-install.sh"
...
echo ""
echo -e "${GR}Deconz installation complete!${NC}"
echo ""
