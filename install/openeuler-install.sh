#!/usr/bin/env bash
# install/openeuler-install.sh — Openeuler
...
header_info "Openeuler"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Openeuler"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/openeuler-install.sh"
...
echo ""
echo -e "${GR}Openeuler installation complete!${NC}"
echo ""
