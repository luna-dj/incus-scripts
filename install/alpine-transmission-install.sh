#!/usr/bin/env bash
# install/alpine-transmission-install.sh — Alpine Transmission
...
header_info "Alpine Transmission"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Transmission"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-transmission-install.sh"
...
echo ""
echo -e "${GR}Alpine Transmission installation complete!${NC}"
echo ""
