#!/usr/bin/env bash
# install/forgejo-install.sh — Forgejo
...
msg_info "Loading upstream install script for Forgejo"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/forgejo-install.sh"
...
echo ""
echo -e "${GR}Forgejo installation complete!${NC}"
echo ""
