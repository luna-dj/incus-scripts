#!/usr/bin/env bash
# install/domain-monitor-install.sh — Domain Monitor
...
header_info "Domain Monitor"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Domain Monitor"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/domain-monitor-install.sh"
...
echo ""
echo -e "${GR}Domain Monitor installation complete!${NC}"
echo ""
