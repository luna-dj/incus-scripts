#!/usr/bin/env bash
# install/portabase-install.sh — Portabase
...
header_info "Portabase"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Portabase"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/portabase-install.sh"
...
echo ""
echo -e "${GR}Portabase installation complete!${NC}"
echo ""
