#!/usr/bin/env bash
# install/archlinux-install.sh — Archlinux
...
header_info "Archlinux"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Archlinux"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/archlinux-install.sh"
...
echo ""
echo -e "${GR}Archlinux installation complete!${NC}"
echo ""
