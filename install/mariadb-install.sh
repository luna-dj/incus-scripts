#!/usr/bin/env bash
# install/mariadb-install.sh — Mariadb
...
msg_info "Loading upstream install script for Mariadb"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/mariadb-install.sh"
...
echo ""
echo -e "${GR}Mariadb installation complete!${NC}"
echo ""
