#!/usr/bin/env bash
# install/etherpad-install.sh — Etherpad
...
header_info "Etherpad"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Etherpad"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/etherpad-install.sh"
...
echo ""
echo -e "${GR}Etherpad installation complete!${NC}"
echo ""
