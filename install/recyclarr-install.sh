#!/usr/bin/env bash
# install/recyclarr-install.sh — Recyclarr
...
header_info "Recyclarr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Recyclarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/recyclarr-install.sh"
...
echo ""
echo -e "${GR}Recyclarr installation complete!${NC}"
echo ""
