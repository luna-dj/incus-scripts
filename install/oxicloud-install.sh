#!/usr/bin/env bash
# install/oxicloud-install.sh — Oxicloud
...
header_info "Oxicloud"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Oxicloud"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/oxicloud-install.sh"
...
echo ""
echo -e "${GR}Oxicloud installation complete!${NC}"
echo ""
