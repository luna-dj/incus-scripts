#!/usr/bin/env bash
# install/baserow-install.sh — Baserow
...
msg_info "Loading upstream install script for Baserow"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/baserow-install.sh"
...
echo ""
echo -e "${GR}Baserow installation complete!${NC}"
echo ""
