#!/usr/bin/env bash
# install/cloudflare-ddns-install.sh — Cloudflare Ddns
...
header_info "Cloudflare Ddns"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Cloudflare Ddns"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/cloudflare-ddns-install.sh"
...
echo ""
echo -e "${GR}Cloudflare Ddns installation complete!${NC}"
echo ""
