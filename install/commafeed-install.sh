#!/usr/bin/env bash
# install/commafeed-install.sh — Commafeed
...
header_info "Commafeed"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Commafeed"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/commafeed-install.sh"
...
echo ""
echo -e "${GR}Commafeed installation complete!${NC}"
echo ""
