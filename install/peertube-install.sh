#!/usr/bin/env bash
# install/peertube-install.sh — Peertube
...
header_info "Peertube"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Peertube"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/peertube-install.sh"
...
echo ""
echo -e "${GR}Peertube installation complete!${NC}"
echo ""
