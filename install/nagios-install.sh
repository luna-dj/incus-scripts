#!/usr/bin/env bash
# install/nagios-install.sh — Nagios
...
msg_info "Loading upstream install script for Nagios"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/nagios-install.sh"
...
echo ""
echo -e "${GR}Nagios installation complete!${NC}"
echo ""
