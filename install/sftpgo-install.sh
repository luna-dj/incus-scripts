#!/usr/bin/env bash
# install/sftpgo-install.sh — Sftpgo
...
msg_info "Loading upstream install script for Sftpgo"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/sftpgo-install.sh"
...
echo ""
echo -e "${GR}Sftpgo installation complete!${NC}"
echo ""
