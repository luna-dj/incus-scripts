#!/usr/bin/env bash
# install/beaverhabits-install.sh — Beaverhabits
...
header_info "Beaverhabits"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Beaverhabits"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/beaverhabits-install.sh"
...
echo ""
echo -e "${GR}Beaverhabits installation complete!${NC}"
echo ""
