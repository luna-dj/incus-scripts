#!/usr/bin/env bash
# install/gatus-install.sh — Gatus
...
msg_info "Loading upstream install script for Gatus"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/gatus-install.sh"
...
echo ""
echo -e "${GR}Gatus installation complete!${NC}"
echo ""
