#!/usr/bin/env bash
# install/rustfs-install.sh — Rustfs
...
msg_info "Loading upstream install script for Rustfs"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/rustfs-install.sh"
...
echo ""
echo -e "${GR}Rustfs installation complete!${NC}"
echo ""
