#!/usr/bin/env bash
# install/strapi-install.sh — Strapi
...
msg_info "Loading upstream install script for Strapi"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/strapi-install.sh"
...
echo ""
echo -e "${GR}Strapi installation complete!${NC}"
echo ""
