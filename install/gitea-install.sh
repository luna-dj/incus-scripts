#!/usr/bin/env bash
# install/gitea-install.sh — Gitea
...
msg_info "Loading upstream install script for Gitea"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/gitea-install.sh"
...
echo ""
echo -e "${GR}Gitea installation complete!${NC}"
echo ""
