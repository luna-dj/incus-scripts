#!/usr/bin/env bash
# install/hister-install.sh — Hister
...
msg_info "Loading upstream install script for Hister"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/hister-install.sh"
...
echo ""
echo -e "${GR}Hister installation complete!${NC}"
echo ""
