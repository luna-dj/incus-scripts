#!/usr/bin/env bash
# install/actualbudget-install.sh — Actualbudget
...
header_info "Actualbudget"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Actualbudget"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/actualbudget-install.sh"
...
echo ""
echo -e "${GR}Actualbudget installation complete!${NC}"
echo ""
