#!/usr/bin/env bash
# install/ownfoil-install.sh — Ownfoil
...
msg_info "Loading upstream install script for Ownfoil"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/ownfoil-install.sh"
...
echo ""
echo -e "${GR}Ownfoil installation complete!${NC}"
echo ""
