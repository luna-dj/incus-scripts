#!/usr/bin/env bash
# install/speedtest-tracker-install.sh — Speedtest Tracker
...
header_info "Speedtest Tracker"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Speedtest Tracker"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/speedtest-tracker-install.sh"
...
echo ""
echo -e "${GR}Speedtest Tracker installation complete!${NC}"
echo ""
