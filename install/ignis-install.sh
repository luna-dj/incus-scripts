#!/usr/bin/env bash
# install/ignis-install.sh — Ignis
...
msg_info "Loading upstream install script for Ignis"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/ignis-install.sh"
...
echo ""
echo -e "${GR}Ignis installation complete!${NC}"
echo ""
