#!/usr/bin/env bash
# install/paymenter-install.sh — Paymenter
...
header_info "Paymenter"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Paymenter"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/paymenter-install.sh"
...
echo ""
echo -e "${GR}Paymenter installation complete!${NC}"
echo ""
