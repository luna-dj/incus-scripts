#!/usr/bin/env bash
# install/hortusfox-install.sh — Hortusfox
...
header_info "Hortusfox"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Hortusfox"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/hortusfox-install.sh"
...
echo ""
echo -e "${GR}Hortusfox installation complete!${NC}"
echo ""
