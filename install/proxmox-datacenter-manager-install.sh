#!/usr/bin/env bash
# install/proxmox-datacenter-manager-install.sh — Proxmox Datacenter Manager
...
header_info "Proxmox Datacenter Manager"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Proxmox Datacenter Manager"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/proxmox-datacenter-manager-install.sh"
...
echo ""
echo -e "${GR}Proxmox Datacenter Manager installation complete!${NC}"
echo ""
