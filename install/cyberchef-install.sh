#!/usr/bin/env bash
# install/cyberchef-install.sh — Cyberchef
...
header_info "Cyberchef"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Cyberchef"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/cyberchef-install.sh"
...
echo ""
echo -e "${GR}Cyberchef installation complete!${NC}"
echo ""
