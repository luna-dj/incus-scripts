#!/usr/bin/env bash
# install/rackula-install.sh — Rackula
...
msg_info "Loading upstream install script for Rackula"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/rackula-install.sh"
...
echo ""
echo -e "${GR}Rackula installation complete!${NC}"
echo ""
