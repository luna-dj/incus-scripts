#!/usr/bin/env bash
# install/forgejo-runner-install.sh — Forgejo Runner
...
header_info "Forgejo Runner"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Forgejo Runner"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/forgejo-runner-install.sh"
...
echo ""
echo -e "${GR}Forgejo Runner installation complete!${NC}"
echo ""
