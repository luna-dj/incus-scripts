#!/usr/bin/env bash
# install/alpine-tinyauth-install.sh — Alpine Tinyauth
...
header_info "Alpine Tinyauth"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Tinyauth"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-tinyauth-install.sh"
...
echo ""
echo -e "${GR}Alpine Tinyauth installation complete!${NC}"
echo ""
