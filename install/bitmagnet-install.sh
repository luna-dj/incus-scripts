#!/usr/bin/env bash
# install/bitmagnet-install.sh — Bitmagnet
...
header_info "Bitmagnet"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Bitmagnet"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/bitmagnet-install.sh"
...
echo ""
echo -e "${GR}Bitmagnet installation complete!${NC}"
echo ""
