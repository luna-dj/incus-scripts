#!/usr/bin/env bash
# install/medusa-install.sh — Medusa
...
msg_info "Loading upstream install script for Medusa"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/medusa-install.sh"
...
echo ""
echo -e "${GR}Medusa installation complete!${NC}"
echo ""
