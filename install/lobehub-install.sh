#!/usr/bin/env bash
# install/lobehub-install.sh — Lobehub
...
msg_info "Loading upstream install script for Lobehub"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/lobehub-install.sh"
...
echo ""
echo -e "${GR}Lobehub installation complete!${NC}"
echo ""
