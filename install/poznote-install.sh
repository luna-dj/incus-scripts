#!/usr/bin/env bash
# install/poznote-install.sh — Poznote
...
msg_info "Loading upstream install script for Poznote"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/poznote-install.sh"
...
echo ""
echo -e "${GR}Poznote installation complete!${NC}"
echo ""
