#!/usr/bin/env bash
# install/phpmyadmin-install.sh — phpMyAdmin (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for phpMyAdmin addon)"
  setup_docker
  msg_ok "Docker installed"
fi

msg_info "Loading upstream addon script for phpMyAdmin"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/phpmyadmin.sh"
...
echo ""
echo -e "${GR}phpMyAdmin installation complete!${NC}"
echo ""
