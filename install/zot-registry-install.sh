#!/usr/bin/env bash
# install/zot-registry-install.sh — Zot Registry
...
header_info "Zot Registry"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Zot Registry"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/zot-registry-install.sh"
...
echo ""
echo -e "${GR}Zot Registry installation complete!${NC}"
echo ""
