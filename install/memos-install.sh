#!/usr/bin/env bash
# install/memos-install.sh — Memos
...
msg_info "Loading upstream install script for Memos"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/memos-install.sh"
...
echo ""
echo -e "${GR}Memos installation complete!${NC}"
echo ""
