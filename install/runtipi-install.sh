#!/usr/bin/env bash
# install/runtipi-install.sh — Runtipi (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Runtipi addon)"
  setup_docker
  msg_ok "Docker installed"
fi

msg_info "Loading upstream addon script for Runtipi"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/runtipi.sh"
...
echo ""
echo -e "${GR}Runtipi installation complete!${NC}"
echo ""
