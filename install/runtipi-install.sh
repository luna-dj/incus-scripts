#!/usr/bin/env bash
# install/runtipi-install.sh — Runtipi
...
msg_info "Loading upstream install script for Runtipi"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/runtipi-install.sh"
