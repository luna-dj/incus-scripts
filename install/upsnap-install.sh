#!/usr/bin/env bash
# install/upsnap-install.sh — Upsnap
...
msg_info "Loading upstream install script for Upsnap"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/upsnap-install.sh"
...
echo ""
echo -e "${GR}Upsnap installation complete!${NC}"
echo ""
