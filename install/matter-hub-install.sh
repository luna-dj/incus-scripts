#!/usr/bin/env bash
# install/matter-hub-install.sh — Matter Hub
...
header_info "Matter Hub"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Matter Hub"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/matter-hub-install.sh"
...
echo ""
echo -e "${GR}Matter Hub installation complete!${NC}"
echo ""
