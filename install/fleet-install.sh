#!/usr/bin/env bash
# install/fleet-install.sh — Fleet
...
msg_info "Loading upstream install script for Fleet"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/fleet-install.sh"
...
echo ""
echo -e "${GR}Fleet installation complete!${NC}"
echo ""
