#!/usr/bin/env bash
# install/snowshare-install.sh — Snowshare
...
header_info "Snowshare"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Snowshare"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/snowshare-install.sh"
...
echo ""
echo -e "${GR}Snowshare installation complete!${NC}"
echo ""
