#!/usr/bin/env bash
# install/netboot-xyz-install.sh — Netboot Xyz
...
header_info "Netboot Xyz"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Netboot Xyz"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/netboot-xyz-install.sh"
...
echo ""
echo -e "${GR}Netboot Xyz installation complete!${NC}"
echo ""
