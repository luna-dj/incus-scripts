#!/usr/bin/env bash
# install/cliproxyapi-install.sh — Cliproxyapi
...
msg_info "Loading upstream install script for Cliproxyapi"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/cliproxyapi-install.sh"
...
echo ""
echo -e "${GR}Cliproxyapi installation complete!${NC}"
echo ""
