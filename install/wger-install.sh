...
msg_info "Loading upstream install script for Wger"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/wger-install.sh"
...
echo ""
echo -e "${GR}Wger installation complete!${NC}"
echo ""
