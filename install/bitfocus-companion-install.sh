#!/usr/bin/env bash
# install/bitfocus-companion-install.sh — Bitfocus Companion
...
header_info "Bitfocus Companion"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Bitfocus Companion"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/bitfocus-companion-install.sh"
...
echo ""
echo -e "${GR}Bitfocus Companion installation complete!${NC}"
echo ""
