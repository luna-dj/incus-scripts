#!/usr/bin/env bash
# install/backrest-install.sh — Backrest
...
header_info "Backrest"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Backrest"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/backrest-install.sh"
...
echo ""
echo -e "${GR}Backrest installation complete!${NC}"
echo ""
