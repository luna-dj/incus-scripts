#!/usr/bin/env bash
# install/flowiseai-install.sh — Flowiseai
...
header_info "Flowiseai"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Flowiseai"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/flowiseai-install.sh"
...
echo ""
echo -e "${GR}Flowiseai installation complete!${NC}"
echo ""
