#!/usr/bin/env bash
# install/zitadel-install.sh — Zitadel
...
msg_info "Loading upstream install script for Zitadel"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/zitadel-install.sh"
...
echo ""
echo -e "${GR}Zitadel installation complete!${NC}"
echo ""
