#!/usr/bin/env bash
# install/litellm-install.sh — Litellm
...
msg_info "Loading upstream install script for Litellm"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/litellm-install.sh"
...
echo ""
echo -e "${GR}Litellm installation complete!${NC}"
echo ""
