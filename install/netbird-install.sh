#!/usr/bin/env bash
# install/netbird-install.sh — Netbird
...
msg_info "Loading upstream install script for Netbird"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/netbird-install.sh"
...
echo ""
echo -e "${GR}Netbird installation complete!${NC}"
echo ""
