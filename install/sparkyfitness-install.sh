#!/usr/bin/env bash
# install/sparkyfitness-install.sh — Sparkyfitness
...
header_info "Sparkyfitness"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Sparkyfitness"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/sparkyfitness-install.sh"
...
echo ""
echo -e "${GR}Sparkyfitness installation complete!${NC}"
echo ""
