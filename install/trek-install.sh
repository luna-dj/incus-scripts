...
msg_info "Loading upstream install script for Trek"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/trek-install.sh"
...
echo ""
echo -e "${GR}Trek installation complete!${NC}"
echo ""
