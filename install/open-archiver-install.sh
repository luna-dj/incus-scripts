#!/usr/bin/env bash
# install/open-archiver-install.sh — Open Archiver
...
header_info "Open Archiver"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Open Archiver"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/open-archiver-install.sh"
...
echo ""
echo -e "${GR}Open Archiver installation complete!${NC}"
echo ""
