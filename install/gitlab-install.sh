#!/usr/bin/env bash
# install/gitlab-install.sh — Gitlab
...
msg_info "Loading upstream install script for Gitlab"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/gitlab-install.sh"
...
echo ""
echo -e "${GR}Gitlab installation complete!${NC}"
echo ""
