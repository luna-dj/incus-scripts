#!/usr/bin/env bash
# install/listmonk-install.sh — Listmonk
...
header_info "Listmonk"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Listmonk"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/listmonk-install.sh"
...
echo ""
echo -e "${GR}Listmonk installation complete!${NC}"
echo ""
