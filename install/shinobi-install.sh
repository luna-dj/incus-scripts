#!/usr/bin/env bash
# install/shinobi-install.sh — Shinobi
...
msg_info "Loading upstream install script for Shinobi"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/shinobi-install.sh"
...
echo ""
echo -e "${GR}Shinobi installation complete!${NC}"
echo ""
