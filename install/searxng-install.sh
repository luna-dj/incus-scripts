#!/usr/bin/env bash
# install/searxng-install.sh — Searxng
...
msg_info "Loading upstream install script for Searxng"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/searxng-install.sh"
...
echo ""
echo -e "${GR}Searxng installation complete!${NC}"
echo ""
