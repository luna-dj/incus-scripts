#!/usr/bin/env bash
# install/erpnext-install.sh — Erpnext
...
msg_info "Loading upstream install script for Erpnext"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/erpnext-install.sh"
...
echo ""
echo -e "${GR}Erpnext installation complete!${NC}"
echo ""
