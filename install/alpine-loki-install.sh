#!/usr/bin/env bash
# install/alpine-loki-install.sh — Alpine Loki
...
header_info "Alpine Loki"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Loki"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-loki-install.sh"
...
echo ""
echo -e "${GR}Alpine Loki installation complete!${NC}"
echo ""
