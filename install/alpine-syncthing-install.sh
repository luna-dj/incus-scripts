#!/usr/bin/env bash
# install/alpine-syncthing-install.sh — Alpine Syncthing
...
header_info "Alpine Syncthing"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Syncthing"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-syncthing-install.sh"
...
echo ""
echo -e "${GR}Alpine Syncthing installation complete!${NC}"
echo ""
