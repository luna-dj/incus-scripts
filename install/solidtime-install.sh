#!/usr/bin/env bash
# install/solidtime-install.sh — Solidtime
...
header_info "Solidtime"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Solidtime"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/solidtime-install.sh"
...
echo ""
echo -e "${GR}Solidtime installation complete!${NC}"
echo ""
