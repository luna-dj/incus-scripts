#!/usr/bin/env bash
# install/journiv-install.sh — Journiv
...
msg_info "Loading upstream install script for Journiv"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/journiv-install.sh"
...
echo ""
echo -e "${GR}Journiv installation complete!${NC}"
echo ""
