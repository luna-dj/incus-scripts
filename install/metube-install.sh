#!/usr/bin/env bash
# install/metube-install.sh — Metube
...
msg_info "Loading upstream install script for Metube"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/metube-install.sh"
...
echo ""
echo -e "${GR}Metube installation complete!${NC}"
echo ""
