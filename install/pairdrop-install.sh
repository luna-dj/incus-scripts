#!/usr/bin/env bash
# install/pairdrop-install.sh — Pairdrop
...
header_info "Pairdrop"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Pairdrop"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/pairdrop-install.sh"
...
echo ""
echo -e "${GR}Pairdrop installation complete!${NC}"
echo ""
