#!/usr/bin/env bash
# install/pve-scripts-local-install.sh — Pve Scripts Local
...
header_info "Pve Scripts Local"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Pve Scripts Local"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/pve-scripts-local-install.sh"
...
echo ""
echo -e "${GR}Pve Scripts Local installation complete!${NC}"
echo ""
