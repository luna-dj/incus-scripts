#!/usr/bin/env bash
# install/teslamate-install.sh — Teslamate
...
header_info "Teslamate"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Teslamate"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/teslamate-install.sh"
...
echo ""
echo -e "${GR}Teslamate installation complete!${NC}"
echo ""
