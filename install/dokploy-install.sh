#!/usr/bin/env bash
# install/dokploy-install.sh — Dokploy
...
msg_info "Loading upstream install script for Dokploy"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/dokploy-install.sh"
