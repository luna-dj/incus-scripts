#!/usr/bin/env bash
# install/seanime-install.sh — Seanime
...
msg_info "Loading upstream install script for Seanime"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/seanime-install.sh"
...
echo ""
echo -e "${GR}Seanime installation complete!${NC}"
echo ""
