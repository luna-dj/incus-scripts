#!/usr/bin/env bash
# install/opencloud-install.sh — Opencloud
...
header_info "Opencloud"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Opencloud"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/opencloud-install.sh"
...
echo ""
echo -e "${GR}Opencloud installation complete!${NC}"
echo ""
