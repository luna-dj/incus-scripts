#!/usr/bin/env bash
# install/gentoo-install.sh — Gentoo
...
msg_info "Loading upstream install script for Gentoo"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/gentoo-install.sh"
...
echo ""
echo -e "${GR}Gentoo installation complete!${NC}"
echo ""
