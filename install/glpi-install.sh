...
msg_info "Loading upstream install script for Glpi"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/glpi-install.sh"
...
echo ""
echo -e "${GR}Glpi installation complete!${NC}"
echo ""
