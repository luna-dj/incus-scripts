#!/usr/bin/env bash
# install/omniroute-install.sh — Omniroute
...
header_info "Omniroute"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Omniroute"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/omniroute-install.sh"
...
echo ""
echo -e "${GR}Omniroute installation complete!${NC}"
echo ""
