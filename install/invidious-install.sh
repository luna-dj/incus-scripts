#!/usr/bin/env bash
# install/invidious-install.sh — Invidious
...
header_info "Invidious"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Invidious"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/invidious-install.sh"
...
echo ""
echo -e "${GR}Invidious installation complete!${NC}"
echo ""
