#!/usr/bin/env bash
# install/step-ca-install.sh — Step Ca
...
msg_info "Loading upstream install script for Step Ca"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/step-ca-install.sh"
...
echo ""
echo -e "${GR}Step Ca installation complete!${NC}"
echo ""
