#!/usr/bin/env bash
# install/tdarr-install.sh — Tdarr
...
msg_info "Loading upstream install script for Tdarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/tdarr-install.sh"
...
echo ""
echo -e "${GR}Tdarr installation complete!${NC}"
echo ""
