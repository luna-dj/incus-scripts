#!/usr/bin/env bash
# install/proxmox-backup-server-install.sh — Proxmox Backup Server
...
header_info "Proxmox Backup Server"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Proxmox Backup Server"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/proxmox-backup-server-install.sh"
...
echo ""
echo -e "${GR}Proxmox Backup Server installation complete!${NC}"
echo ""
