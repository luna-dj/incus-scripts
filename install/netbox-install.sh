#!/usr/bin/env bash
# install/netbox-install.sh — Netbox
...
msg_info "Loading upstream install script for Netbox"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/netbox-install.sh"
...
echo ""
echo -e "${GR}Netbox installation complete!${NC}"
echo ""
