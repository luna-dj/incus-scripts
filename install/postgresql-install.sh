#!/usr/bin/env bash
# install/postgresql-install.sh — Postgresql
...
header_info "Postgresql"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Postgresql"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/postgresql-install.sh"
...
echo ""
echo -e "${GR}Postgresql installation complete!${NC}"
echo ""
