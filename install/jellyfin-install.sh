#!/usr/bin/env bash
# install/jellyfin-install.sh — Jellyfin
...
header_info "Jellyfin"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Jellyfin"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/jellyfin-install.sh"
...
echo ""
echo -e "${GR}Jellyfin installation complete!${NC}"
echo ""
