#!/usr/bin/env bash
# install/ps5-mqtt-install.sh — Ps5 Mqtt
...
header_info "Ps5 Mqtt"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Ps5 Mqtt"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/ps5-mqtt-install.sh"
...
echo ""
echo -e "${GR}Ps5 Mqtt installation complete!${NC}"
echo ""
