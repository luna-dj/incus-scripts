#!/usr/bin/env bash
# install/zipline-install.sh — Zipline
...
msg_info "Loading upstream install script for Zipline"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/zipline-install.sh"
...
echo ""
echo -e "${GR}Zipline installation complete!${NC}"
echo ""
