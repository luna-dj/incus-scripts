#!/usr/bin/env bash
# install/hermesagent-install.sh — Hermesagent
...
header_info "Hermesagent"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Hermesagent"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/hermesagent-install.sh"
...
echo ""
echo -e "${GR}Hermesagent installation complete!${NC}"
echo ""
