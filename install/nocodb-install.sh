#!/usr/bin/env bash
# install/nocodb-install.sh — Nocodb
...
msg_info "Loading upstream install script for Nocodb"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/nocodb-install.sh"
...
echo ""
echo -e "${GR}Nocodb installation complete!${NC}"
echo ""
