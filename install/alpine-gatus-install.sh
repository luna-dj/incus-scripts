#!/usr/bin/env bash
# install/alpine-gatus-install.sh — Alpine Gatus
...
header_info "Alpine Gatus"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Gatus"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-gatus-install.sh"
...
echo ""
echo -e "${GR}Alpine Gatus installation complete!${NC}"
echo ""
