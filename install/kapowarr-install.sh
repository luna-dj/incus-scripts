#!/usr/bin/env bash
# install/kapowarr-install.sh — Kapowarr
...
header_info "Kapowarr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Kapowarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/kapowarr-install.sh"
...
echo ""
echo -e "${GR}Kapowarr installation complete!${NC}"
echo ""
