#!/usr/bin/env bash
# install/solidinvoice-install.sh — Solidinvoice
...
header_info "Solidinvoice"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Solidinvoice"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/solidinvoice-install.sh"
...
echo ""
echo -e "${GR}Solidinvoice installation complete!${NC}"
echo ""
