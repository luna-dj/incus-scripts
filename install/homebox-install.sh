#!/usr/bin/env bash
# install/homebox-install.sh — Homebox
...
msg_info "Loading upstream install script for Homebox"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/homebox-install.sh"
...
echo ""
echo -e "${GR}Homebox installation complete!${NC}"
echo ""
