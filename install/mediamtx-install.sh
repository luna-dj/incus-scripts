#!/usr/bin/env bash
# install/mediamtx-install.sh — Mediamtx
...
header_info "Mediamtx"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Mediamtx"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/mediamtx-install.sh"
...
echo ""
echo -e "${GR}Mediamtx installation complete!${NC}"
echo ""
