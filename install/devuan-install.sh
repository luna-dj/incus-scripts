#!/usr/bin/env bash
# install/devuan-install.sh — Devuan
...
msg_info "Loading upstream install script for Devuan"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/devuan-install.sh"
...
echo ""
echo -e "${GR}Devuan installation complete!${NC}"
echo ""
