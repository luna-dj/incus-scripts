#!/usr/bin/env bash
# install/iobroker-install.sh — Iobroker
...
header_info "Iobroker"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Iobroker"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/iobroker-install.sh"
...
echo ""
echo -e "${GR}Iobroker installation complete!${NC}"
echo ""
