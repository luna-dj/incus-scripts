#!/usr/bin/env bash
# install/dotnetaspwebapi-install.sh — Dotnetaspwebapi
...
header_info "Dotnetaspwebapi"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Dotnetaspwebapi"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/dotnetaspwebapi-install.sh"
...
echo ""
echo -e "${GR}Dotnetaspwebapi installation complete!${NC}"
echo ""
