...
msg_info "Loading upstream install script for Sure"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/sure-install.sh"
...
echo ""
echo -e "${GR}Sure installation complete!${NC}"
echo ""
