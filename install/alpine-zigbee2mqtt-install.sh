#!/usr/bin/env bash
# install/alpine-zigbee2mqtt-install.sh — Alpine Zigbee2Mqtt
...
header_info "Alpine Zigbee2Mqtt"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Zigbee2Mqtt"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-zigbee2mqtt-install.sh"
...
echo ""
echo -e "${GR}Alpine Zigbee2Mqtt installation complete!${NC}"
echo ""
