#!/usr/bin/env bash
# install/mailpit-install.sh — Mailpit
...
msg_info "Loading upstream install script for Mailpit"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/mailpit-install.sh"
...
echo ""
echo -e "${GR}Mailpit installation complete!${NC}"
echo ""
