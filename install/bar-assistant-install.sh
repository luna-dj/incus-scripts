#!/usr/bin/env bash
# install/bar-assistant-install.sh — Bar Assistant
...
header_info "Bar Assistant"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Bar Assistant"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/bar-assistant-install.sh"
...
echo ""
echo -e "${GR}Bar Assistant installation complete!${NC}"
echo ""
