#!/usr/bin/env bash
# install/discourse-install.sh — Discourse
...
header_info "Discourse"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Discourse"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/discourse-install.sh"
...
echo ""
echo -e "${GR}Discourse installation complete!${NC}"
echo ""
