#!/usr/bin/env bash
# install/obsidian-livesync-install.sh — Obsidian Livesync
...
header_info "Obsidian Livesync"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Obsidian Livesync"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/obsidian-livesync-install.sh"
...
echo ""
echo -e "${GR}Obsidian Livesync installation complete!${NC}"
echo ""
