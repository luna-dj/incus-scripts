#!/usr/bin/env bash
# install/umbraco-install.sh — Umbraco
...
msg_info "Loading upstream install script for Umbraco"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/umbraco-install.sh"
...
echo ""
echo -e "${GR}Umbraco installation complete!${NC}"
echo ""
