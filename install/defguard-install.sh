#!/usr/bin/env bash
# install/defguard-install.sh — Defguard
...
header_info "Defguard"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Defguard"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/defguard-install.sh"
...
echo ""
echo -e "${GR}Defguard installation complete!${NC}"
echo ""
