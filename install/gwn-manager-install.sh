#!/usr/bin/env bash
# install/gwn-manager-install.sh — Gwn Manager
...
header_info "Gwn Manager"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Gwn Manager"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/gwn-manager-install.sh"
...
echo ""
echo -e "${GR}Gwn Manager installation complete!${NC}"
echo ""
