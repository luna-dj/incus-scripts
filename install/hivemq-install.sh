#!/usr/bin/env bash
# install/hivemq-install.sh — Hivemq
...
msg_info "Loading upstream install script for Hivemq"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/hivemq-install.sh"
...
echo ""
echo -e "${GR}Hivemq installation complete!${NC}"
echo ""
