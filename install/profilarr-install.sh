#!/usr/bin/env bash
# install/profilarr-install.sh — Profilarr
...
header_info "Profilarr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Profilarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/profilarr-install.sh"
...
echo ""
echo -e "${GR}Profilarr installation complete!${NC}"
echo ""
