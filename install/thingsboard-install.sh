#!/usr/bin/env bash
# install/thingsboard-install.sh — Thingsboard
...
header_info "Thingsboard"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Thingsboard"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/thingsboard-install.sh"
...
echo ""
echo -e "${GR}Thingsboard installation complete!${NC}"
echo ""
