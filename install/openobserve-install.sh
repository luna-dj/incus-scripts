#!/usr/bin/env bash
# install/openobserve-install.sh — Openobserve
...
header_info "Openobserve"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Openobserve"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/openobserve-install.sh"
...
echo ""
echo -e "${GR}Openobserve installation complete!${NC}"
echo ""
