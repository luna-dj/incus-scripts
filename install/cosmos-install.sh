#!/usr/bin/env bash
# install/cosmos-install.sh — Cosmos
...
msg_info "Loading upstream install script for Cosmos"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/cosmos-install.sh"
...
echo ""
echo -e "${GR}Cosmos installation complete!${NC}"
echo ""
