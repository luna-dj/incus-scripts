#!/usr/bin/env bash
# install/vikunja-install.sh — Vikunja
...
msg_info "Loading upstream install script for Vikunja"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/vikunja-install.sh"
...
echo ""
echo -e "${GR}Vikunja installation complete!${NC}"
echo ""
