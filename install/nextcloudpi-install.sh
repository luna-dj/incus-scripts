#!/usr/bin/env bash
# install/nextcloudpi-install.sh — Nextcloudpi
...
header_info "Nextcloudpi"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Nextcloudpi"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/nextcloudpi-install.sh"
...
echo ""
echo -e "${GR}Nextcloudpi installation complete!${NC}"
echo ""
