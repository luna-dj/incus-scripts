#!/usr/bin/env bash
# install/influxdb-install.sh — Influxdb
...
header_info "Influxdb"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Influxdb"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/influxdb-install.sh"
...
echo ""
echo -e "${GR}Influxdb installation complete!${NC}"
echo ""
