#!/usr/bin/env bash
# install/alpine-docker-install.sh — Alpine Docker
...
header_info "Alpine Docker"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Docker"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-docker-install.sh"
...
echo ""
echo -e "${GR}Alpine Docker installation complete!${NC}"
echo ""
