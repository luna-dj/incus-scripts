#!/usr/bin/env bash
# install/alpine-teamspeak-server-install.sh — Alpine Teamspeak Server
...
header_info "Alpine Teamspeak Server"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Teamspeak Server"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-teamspeak-server-install.sh"
...
echo ""
echo -e "${GR}Alpine Teamspeak Server installation complete!${NC}"
echo ""
