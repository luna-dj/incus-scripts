#!/usr/bin/env bash
# install/tandoor-install.sh — Tandoor
...
msg_info "Loading upstream install script for Tandoor"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/tandoor-install.sh"
...
echo ""
echo -e "${GR}Tandoor installation complete!${NC}"
echo ""
