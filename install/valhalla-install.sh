#!/usr/bin/env bash
# install/valhalla-install.sh — Valhalla
...
header_info "Valhalla"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Valhalla"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/valhalla-install.sh"
...
echo ""
echo -e "${GR}Valhalla installation complete!${NC}"
echo ""
