#!/usr/bin/env bash
# install/openhab-install.sh — Openhab
...
msg_info "Loading upstream install script for Openhab"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/openhab-install.sh"
...
echo ""
echo -e "${GR}Openhab installation complete!${NC}"
echo ""
