#!/usr/bin/env bash
# install/alpine-gitea-install.sh — Alpine Gitea
...
header_info "Alpine Gitea"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Gitea"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-gitea-install.sh"
...
echo ""
echo -e "${GR}Alpine Gitea installation complete!${NC}"
echo ""
