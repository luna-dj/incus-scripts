...
msg_info "Loading upstream install script for Qui"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/qui-install.sh"
...
echo ""
echo -e "${GR}Qui installation complete!${NC}"
echo ""
