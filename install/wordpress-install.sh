#!/usr/bin/env bash
# install/wordpress-install.sh — Wordpress
...
header_info "Wordpress"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Wordpress"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/wordpress-install.sh"
...
echo ""
echo -e "${GR}Wordpress installation complete!${NC}"
echo ""
