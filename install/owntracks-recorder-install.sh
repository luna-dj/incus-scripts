#!/usr/bin/env bash
# install/owntracks-recorder-install.sh — Owntracks Recorder
...
header_info "Owntracks Recorder"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Owntracks Recorder"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/owntracks-recorder-install.sh"
...
echo ""
echo -e "${GR}Owntracks Recorder installation complete!${NC}"
echo ""
