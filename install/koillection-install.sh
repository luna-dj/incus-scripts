#!/usr/bin/env bash
# install/koillection-install.sh — Koillection
...
header_info "Koillection"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Koillection"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/koillection-install.sh"
...
echo ""
echo -e "${GR}Koillection installation complete!${NC}"
echo ""
