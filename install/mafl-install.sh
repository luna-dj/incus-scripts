...
msg_info "Loading upstream install script for Mafl"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/mafl-install.sh"
...
echo ""
echo -e "${GR}Mafl installation complete!${NC}"
echo ""
