#!/usr/bin/env bash
# install/notediscovery-install.sh — Notediscovery
...
header_info "Notediscovery"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Notediscovery"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/notediscovery-install.sh"
...
echo ""
echo -e "${GR}Notediscovery installation complete!${NC}"
echo ""
