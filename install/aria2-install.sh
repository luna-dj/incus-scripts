#!/usr/bin/env bash
# install/aria2-install.sh — Aria2
...
msg_info "Loading upstream install script for Aria2"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/aria2-install.sh"
...
echo ""
echo -e "${GR}Aria2 installation complete!${NC}"
echo ""
