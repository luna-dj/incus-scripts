#!/usr/bin/env bash
# install/calibre-web-install.sh — Calibre Web
...
header_info "Calibre Web"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Calibre Web"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/calibre-web-install.sh"
...
echo ""
echo -e "${GR}Calibre Web installation complete!${NC}"
echo ""
