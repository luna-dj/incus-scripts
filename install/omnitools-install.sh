#!/usr/bin/env bash
# install/omnitools-install.sh — Omnitools
...
header_info "Omnitools"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Omnitools"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/omnitools-install.sh"
...
echo ""
echo -e "${GR}Omnitools installation complete!${NC}"
echo ""
