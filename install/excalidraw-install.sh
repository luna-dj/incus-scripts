#!/usr/bin/env bash
# install/excalidraw-install.sh — Excalidraw
...
header_info "Excalidraw"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Excalidraw"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/excalidraw-install.sh"
...
echo ""
echo -e "${GR}Excalidraw installation complete!${NC}"
echo ""
