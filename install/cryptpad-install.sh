#!/usr/bin/env bash
# install/cryptpad-install.sh — Cryptpad
...
header_info "Cryptpad"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Cryptpad"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/cryptpad-install.sh"
...
echo ""
echo -e "${GR}Cryptpad installation complete!${NC}"
echo ""
