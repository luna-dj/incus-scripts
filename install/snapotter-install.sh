#!/usr/bin/env bash
# install/snapotter-install.sh — Snapotter
...
header_info "Snapotter"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Snapotter"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/snapotter-install.sh"
...
echo ""
echo -e "${GR}Snapotter installation complete!${NC}"
echo ""
