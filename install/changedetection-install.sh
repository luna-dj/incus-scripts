#!/usr/bin/env bash
# install/changedetection-install.sh — Changedetection
...
header_info "Changedetection"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Changedetection"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/changedetection-install.sh"
...
echo ""
echo -e "${GR}Changedetection installation complete!${NC}"
echo ""
