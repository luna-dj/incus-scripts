#!/usr/bin/env bash
# install/ebusd-install.sh — Ebusd
...
msg_info "Loading upstream install script for Ebusd"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/ebusd-install.sh"
...
echo ""
echo -e "${GR}Ebusd installation complete!${NC}"
echo ""
