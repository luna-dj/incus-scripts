...
msg_info "Loading upstream install script for Orb"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/orb-install.sh"
...
echo ""
echo -e "${GR}Orb installation complete!${NC}"
echo ""
