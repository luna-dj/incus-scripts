#!/usr/bin/env bash
# install/lldap-install.sh — Lldap
...
msg_info "Loading upstream install script for Lldap"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/lldap-install.sh"
...
echo ""
echo -e "${GR}Lldap installation complete!${NC}"
echo ""
