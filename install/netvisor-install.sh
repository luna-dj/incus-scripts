#!/usr/bin/env bash
# install/netvisor-install.sh — Netvisor
...
header_info "Netvisor"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Netvisor"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/netvisor-install.sh"
...
echo ""
echo -e "${GR}Netvisor installation complete!${NC}"
echo ""
