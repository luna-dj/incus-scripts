...
msg_info "Loading upstream install script for Ntfy"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/ntfy-install.sh"
...
echo ""
echo -e "${GR}Ntfy installation complete!${NC}"
echo ""
