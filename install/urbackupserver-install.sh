#!/usr/bin/env bash
# install/urbackupserver-install.sh — Urbackupserver
...
header_info "Urbackupserver"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Urbackupserver"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/urbackupserver-install.sh"
...
echo ""
echo -e "${GR}Urbackupserver installation complete!${NC}"
echo ""
