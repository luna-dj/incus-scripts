#!/usr/bin/env bash
# install/filebrowser-install.sh — Filebrowser (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Filebrowser addon)"
  setup_docker
  msg_ok "Docker installed"
fi

msg_info "Loading upstream addon script for Filebrowser"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/filebrowser.sh"
...
echo ""
echo -e "${GR}Filebrowser installation complete!${NC}"
echo ""
