#!/usr/bin/env bash
# install/openbao-install.sh — Openbao
...
msg_info "Loading upstream install script for Openbao"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/openbao-install.sh"
...
echo ""
echo -e "${GR}Openbao installation complete!${NC}"
echo ""
