#!/usr/bin/env bash
# install/nametag-install.sh — Nametag
...
msg_info "Loading upstream install script for Nametag"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/nametag-install.sh"
...
echo ""
echo -e "${GR}Nametag installation complete!${NC}"
echo ""
