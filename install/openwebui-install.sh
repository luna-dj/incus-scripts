#!/usr/bin/env bash
# install/openwebui-install.sh — Openwebui
...
header_info "Openwebui"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Openwebui"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/openwebui-install.sh"
...
echo ""
echo -e "${GR}Openwebui installation complete!${NC}"
echo ""
