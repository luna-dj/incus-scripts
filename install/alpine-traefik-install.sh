#!/usr/bin/env bash
# install/alpine-traefik-install.sh — Alpine Traefik
...
header_info "Alpine Traefik"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Traefik"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-traefik-install.sh"
...
echo ""
echo -e "${GR}Alpine Traefik installation complete!${NC}"
echo ""
