#!/usr/bin/env bash
# install/apache-tika-install.sh — Apache Tika
...
header_info "Apache Tika"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Apache Tika"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/apache-tika-install.sh"
...
echo ""
echo -e "${GR}Apache Tika installation complete!${NC}"
echo ""
