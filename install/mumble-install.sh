#!/usr/bin/env bash
# install/mumble-install.sh — Mumble
...
msg_info "Loading upstream install script for Mumble"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/mumble-install.sh"
...
echo ""
echo -e "${GR}Mumble installation complete!${NC}"
echo ""
