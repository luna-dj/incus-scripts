#!/usr/bin/env bash
# install/readmeabook-install.sh — Readmeabook
...
header_info "Readmeabook"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Readmeabook"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/readmeabook-install.sh"
...
echo ""
echo -e "${GR}Readmeabook installation complete!${NC}"
echo ""
