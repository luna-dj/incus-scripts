#!/usr/bin/env bash
# install/readarr-install.sh — Readarr
...
msg_info "Loading upstream install script for Readarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/readarr-install.sh"
...
echo ""
echo -e "${GR}Readarr installation complete!${NC}"
echo ""
