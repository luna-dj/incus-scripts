#!/usr/bin/env bash
# install/wastebin-install.sh — Wastebin
...
header_info "Wastebin"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Wastebin"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/wastebin-install.sh"
...
echo ""
echo -e "${GR}Wastebin installation complete!${NC}"
echo ""
