#!/usr/bin/env bash
# install/overseerr-install.sh — Overseerr
...
header_info "Overseerr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Overseerr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/overseerr-install.sh"
...
echo ""
echo -e "${GR}Overseerr installation complete!${NC}"
echo ""
