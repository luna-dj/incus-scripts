#!/usr/bin/env bash
# install/grafana-install.sh — Grafana
...
msg_info "Loading upstream install script for Grafana"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/grafana-install.sh"
...
echo ""
echo -e "${GR}Grafana installation complete!${NC}"
echo ""
