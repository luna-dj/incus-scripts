#!/usr/bin/env bash
# install/cronmaster-install.sh — Cronmaster (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Cronmaster addon)"
  setup_docker
  msg_ok "Docker installed"
fi

msg_info "Loading upstream addon script for Cronmaster"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/cronmaster.sh"
...
echo ""
echo -e "${GR}Cronmaster installation complete!${NC}"
echo ""
