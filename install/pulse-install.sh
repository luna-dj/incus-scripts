#!/usr/bin/env bash
# install/pulse-install.sh — Pulse
...
msg_info "Loading upstream install script for Pulse"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/pulse-install.sh"
...
echo ""
echo -e "${GR}Pulse installation complete!${NC}"
echo ""
