#!/usr/bin/env bash
# install/openziti-tunnel-install.sh — Openziti Tunnel
...
header_info "Openziti Tunnel"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Openziti Tunnel"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/openziti-tunnel-install.sh"
...
echo ""
echo -e "${GR}Openziti Tunnel installation complete!${NC}"
echo ""
