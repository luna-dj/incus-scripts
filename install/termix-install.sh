#!/usr/bin/env bash
# install/termix-install.sh — Termix
...
msg_info "Loading upstream install script for Termix"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/termix-install.sh"
...
echo ""
echo -e "${GR}Termix installation complete!${NC}"
echo ""
