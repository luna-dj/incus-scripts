#!/usr/bin/env bash
# install/grist-install.sh — Grist
...
msg_info "Loading upstream install script for Grist"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/grist-install.sh"
...
echo ""
echo -e "${GR}Grist installation complete!${NC}"
echo ""
