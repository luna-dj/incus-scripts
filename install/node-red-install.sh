#!/usr/bin/env bash
# install/node-red-install.sh — Node Red
...
header_info "Node Red"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Node Red"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/node-red-install.sh"
...
echo ""
echo -e "${GR}Node Red installation complete!${NC}"
echo ""
