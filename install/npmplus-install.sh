#!/usr/bin/env bash
# install/npmplus-install.sh — Npmplus
...
msg_info "Loading upstream install script for Npmplus"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/npmplus-install.sh"
...
echo ""
echo -e "${GR}Npmplus installation complete!${NC}"
echo ""
