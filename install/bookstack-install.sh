#!/usr/bin/env bash
# install/bookstack-install.sh — Bookstack
...
header_info "Bookstack"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Bookstack"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/bookstack-install.sh"
...
echo ""
echo -e "${GR}Bookstack installation complete!${NC}"
echo ""
