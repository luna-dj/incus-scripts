#!/usr/bin/env bash
# install/matterjs-server-install.sh — Matterjs Server
...
header_info "Matterjs Server"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Matterjs Server"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/matterjs-server-install.sh"
...
echo ""
echo -e "${GR}Matterjs Server installation complete!${NC}"
echo ""
