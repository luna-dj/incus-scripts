#!/usr/bin/env bash
# install/pyenv-install.sh — Pyenv (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Pyenv addon)"
  setup_docker
  msg_ok "Docker installed"
fi

msg_info "Loading upstream addon script for Pyenv"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/pyenv.sh"
...
echo ""
echo -e "${GR}Pyenv installation complete!${NC}"
echo ""
