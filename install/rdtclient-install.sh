#!/usr/bin/env bash
# install/rdtclient-install.sh — Rdtclient
...
header_info "Rdtclient"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Rdtclient"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/rdtclient-install.sh"
...
echo ""
echo -e "${GR}Rdtclient installation complete!${NC}"
echo ""
