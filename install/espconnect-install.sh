#!/usr/bin/env bash
# install/espconnect-install.sh — Espconnect
...
header_info "Espconnect"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Espconnect"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/espconnect-install.sh"
...
echo ""
echo -e "${GR}Espconnect installation complete!${NC}"
echo ""
