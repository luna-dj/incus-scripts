#!/usr/bin/env bash
# install/spliit-install.sh — Spliit
...
msg_info "Loading upstream install script for Spliit"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/spliit-install.sh"
...
echo ""
echo -e "${GR}Spliit installation complete!${NC}"
echo ""
