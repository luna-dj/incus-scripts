...
msg_info "Loading upstream install script for Ots"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/ots-install.sh"
...
echo ""
echo -e "${GR}Ots installation complete!${NC}"
echo ""
