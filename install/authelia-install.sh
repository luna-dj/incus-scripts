#!/usr/bin/env bash
# install/authelia-install.sh — Authelia
...
header_info "Authelia"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Authelia"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/authelia-install.sh"
...
echo ""
echo -e "${GR}Authelia installation complete!${NC}"
echo ""
