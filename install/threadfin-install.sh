#!/usr/bin/env bash
# install/threadfin-install.sh — Threadfin
...
header_info "Threadfin"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Threadfin"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/threadfin-install.sh"
...
echo ""
echo -e "${GR}Threadfin installation complete!${NC}"
echo ""
