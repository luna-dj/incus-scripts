#!/usr/bin/env bash
# install/powerdns-install.sh — Powerdns
...
header_info "Powerdns"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Powerdns"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/powerdns-install.sh"
...
echo ""
echo -e "${GR}Powerdns installation complete!${NC}"
echo ""
