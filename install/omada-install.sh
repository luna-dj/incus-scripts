#!/usr/bin/env bash
# install/omada-install.sh — Omada
...
msg_info "Loading upstream install script for Omada"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/omada-install.sh"
...
echo ""
echo -e "${GR}Omada installation complete!${NC}"
echo ""
