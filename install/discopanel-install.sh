#!/usr/bin/env bash
# install/discopanel-install.sh — Discopanel
...
header_info "Discopanel"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Discopanel"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/discopanel-install.sh"
...
echo ""
echo -e "${GR}Discopanel installation complete!${NC}"
echo ""
