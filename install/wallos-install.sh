#!/usr/bin/env bash
# install/wallos-install.sh — Wallos
...
msg_info "Loading upstream install script for Wallos"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/wallos-install.sh"
...
echo ""
echo -e "${GR}Wallos installation complete!${NC}"
echo ""
