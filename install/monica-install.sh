#!/usr/bin/env bash
# install/monica-install.sh — Monica
...
msg_info "Loading upstream install script for Monica"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/monica-install.sh"
...
echo ""
echo -e "${GR}Monica installation complete!${NC}"
echo ""
