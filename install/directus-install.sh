#!/usr/bin/env bash
# install/directus-install.sh — Directus
...
header_info "Directus"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Directus"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/directus-install.sh"
...
echo ""
echo -e "${GR}Directus installation complete!${NC}"
echo ""
