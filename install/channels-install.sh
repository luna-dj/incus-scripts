#!/usr/bin/env bash
# install/channels-install.sh — Channels
...
msg_info "Loading upstream install script for Channels"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/channels-install.sh"
...
echo ""
echo -e "${GR}Channels installation complete!${NC}"
echo ""
