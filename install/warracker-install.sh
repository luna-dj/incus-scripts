#!/usr/bin/env bash
# install/warracker-install.sh — Warracker
...
header_info "Warracker"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Warracker"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/warracker-install.sh"
...
echo ""
echo -e "${GR}Warracker installation complete!${NC}"
echo ""
