#!/usr/bin/env bash
# install/zwave-js-ui-install.sh — Zwave Js Ui
...
header_info "Zwave Js Ui"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Zwave Js Ui"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/zwave-js-ui-install.sh"
...
echo ""
echo -e "${GR}Zwave Js Ui installation complete!${NC}"
echo ""
