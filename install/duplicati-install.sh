#!/usr/bin/env bash
# install/duplicati-install.sh — Duplicati
...
header_info "Duplicati"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Duplicati"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/duplicati-install.sh"
...
echo ""
echo -e "${GR}Duplicati installation complete!${NC}"
echo ""
