#!/usr/bin/env bash
# install/deluge-install.sh — Deluge
...
msg_info "Loading upstream install script for Deluge"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/deluge-install.sh"
...
echo ""
echo -e "${GR}Deluge installation complete!${NC}"
echo ""
