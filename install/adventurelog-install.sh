#!/usr/bin/env bash
# install/adventurelog-install.sh — Adventurelog
...
header_info "Adventurelog"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Adventurelog"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/adventurelog-install.sh"
...
echo ""
echo -e "${GR}Adventurelog installation complete!${NC}"
echo ""
