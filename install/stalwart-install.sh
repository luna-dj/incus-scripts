#!/usr/bin/env bash
# install/stalwart-install.sh — Stalwart
...
header_info "Stalwart"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Stalwart"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/stalwart-install.sh"
...
echo ""
echo -e "${GR}Stalwart installation complete!${NC}"
echo ""
