#!/usr/bin/env bash
# install/homepage-install.sh — Homepage
...
header_info "Homepage"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Homepage"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/homepage-install.sh"
...
echo ""
echo -e "${GR}Homepage installation complete!${NC}"
echo ""
