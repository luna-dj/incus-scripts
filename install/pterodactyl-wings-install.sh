#!/usr/bin/env bash
# install/pterodactyl-wings-install.sh — Pterodactyl Wings
...
header_info "Pterodactyl Wings"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Pterodactyl Wings"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/pterodactyl-wings-install.sh"
...
echo ""
echo -e "${GR}Pterodactyl Wings installation complete!${NC}"
echo ""
