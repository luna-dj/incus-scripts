#!/usr/bin/env bash
# install/koffan-install.sh — Koffan
...
msg_info "Loading upstream install script for Koffan"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/koffan-install.sh"
...
echo ""
echo -e "${GR}Koffan installation complete!${NC}"
echo ""
