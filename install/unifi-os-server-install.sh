#!/usr/bin/env bash
# install/unifi-os-server-install.sh — Unifi Os Server
...
header_info "Unifi Os Server"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Unifi Os Server"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/unifi-os-server-install.sh"
...
echo ""
echo -e "${GR}Unifi Os Server installation complete!${NC}"
echo ""
