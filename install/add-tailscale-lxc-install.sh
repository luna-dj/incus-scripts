#!/usr/bin/env bash
# install/add-tailscale-lxc-install.sh — Add Tailscale Lxc (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Add Tailscale Lxc addon)"
  setup_docker
  msg_ok "Docker installed"
fi

msg_info "Loading upstream addon script for Add Tailscale Lxc"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/add-tailscale-lxc.sh"
...
echo ""
echo -e "${GR}Add Tailscale Lxc installation complete!${NC}"
echo ""
