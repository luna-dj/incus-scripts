#!/usr/bin/env bash
# install/traefik-install.sh — Traefik
...
msg_info "Loading upstream install script for Traefik"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/traefik-install.sh"
...
echo ""
echo -e "${GR}Traefik installation complete!${NC}"
echo ""
