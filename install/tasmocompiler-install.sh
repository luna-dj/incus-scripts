#!/usr/bin/env bash
# install/tasmocompiler-install.sh — Tasmocompiler
...
header_info "Tasmocompiler"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Tasmocompiler"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/tasmocompiler-install.sh"
...
echo ""
echo -e "${GR}Tasmocompiler installation complete!${NC}"
echo ""
