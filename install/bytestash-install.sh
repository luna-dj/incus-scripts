#!/usr/bin/env bash
# install/bytestash-install.sh — Bytestash
...
header_info "Bytestash"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Bytestash"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/bytestash-install.sh"
...
echo ""
echo -e "${GR}Bytestash installation complete!${NC}"
echo ""
