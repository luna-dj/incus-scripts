#!/usr/bin/env bash
# install/yubal-install.sh — Yubal
...
msg_info "Loading upstream install script for Yubal"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/yubal-install.sh"
...
echo ""
echo -e "${GR}Yubal installation complete!${NC}"
echo ""
