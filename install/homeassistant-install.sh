#!/usr/bin/env bash
# install/homeassistant-install.sh — Homeassistant
...
header_info "Homeassistant"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Homeassistant"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/homeassistant-install.sh"
...
echo ""
echo -e "${GR}Homeassistant installation complete!${NC}"
echo ""
