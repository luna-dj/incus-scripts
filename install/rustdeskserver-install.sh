#!/usr/bin/env bash
# install/rustdeskserver-install.sh — Rustdeskserver
...
header_info "Rustdeskserver"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Rustdeskserver"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/rustdeskserver-install.sh"
...
echo ""
echo -e "${GR}Rustdeskserver installation complete!${NC}"
echo ""
