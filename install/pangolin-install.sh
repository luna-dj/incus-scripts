#!/usr/bin/env bash
# install/pangolin-install.sh — Pangolin
...
msg_info "Loading upstream install script for Pangolin"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/pangolin-install.sh"
...
echo ""
echo -e "${GR}Pangolin installation complete!${NC}"
echo ""
