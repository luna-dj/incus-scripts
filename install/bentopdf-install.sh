#!/usr/bin/env bash
# install/bentopdf-install.sh — Bentopdf
...
header_info "Bentopdf"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Bentopdf"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/bentopdf-install.sh"
...
echo ""
echo -e "${GR}Bentopdf installation complete!${NC}"
echo ""
