#!/usr/bin/env bash
# install/tianji-install.sh — Tianji
...
msg_info "Loading upstream install script for Tianji"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/tianji-install.sh"
...
echo ""
echo -e "${GR}Tianji installation complete!${NC}"
echo ""
