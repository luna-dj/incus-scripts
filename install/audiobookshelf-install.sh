#!/usr/bin/env bash
# install/audiobookshelf-install.sh — Audiobookshelf
...
header_info "Audiobookshelf"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Audiobookshelf"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/audiobookshelf-install.sh"
...
echo ""
echo -e "${GR}Audiobookshelf installation complete!${NC}"
echo ""
