#!/usr/bin/env bash
# install/pelican-panel-install.sh — Pelican Panel
...
header_info "Pelican Panel"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Pelican Panel"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/pelican-panel-install.sh"
...
echo ""
echo -e "${GR}Pelican Panel installation complete!${NC}"
echo ""
