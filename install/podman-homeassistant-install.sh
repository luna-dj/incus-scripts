#!/usr/bin/env bash
# install/podman-homeassistant-install.sh — Podman Homeassistant
...
header_info "Podman Homeassistant"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Podman Homeassistant"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/podman-homeassistant-install.sh"
...
echo ""
echo -e "${GR}Podman Homeassistant installation complete!${NC}"
echo ""
