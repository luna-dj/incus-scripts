#!/usr/bin/env bash
# install/grocy-install.sh — Grocy
...
msg_info "Loading upstream install script for Grocy"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/grocy-install.sh"
...
echo ""
echo -e "${GR}Grocy installation complete!${NC}"
echo ""
