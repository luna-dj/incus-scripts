#!/usr/bin/env bash
# install/pocketid-install.sh — Pocketid
...
header_info "Pocketid"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Pocketid"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/pocketid-install.sh"
...
echo ""
echo -e "${GR}Pocketid installation complete!${NC}"
echo ""
