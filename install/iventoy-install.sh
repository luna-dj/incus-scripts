#!/usr/bin/env bash
# install/iventoy-install.sh — Iventoy
...
msg_info "Loading upstream install script for Iventoy"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/iventoy-install.sh"
...
echo ""
echo -e "${GR}Iventoy installation complete!${NC}"
echo ""
