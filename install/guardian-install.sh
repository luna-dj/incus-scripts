#!/usr/bin/env bash
# install/guardian-install.sh — Guardian
...
header_info "Guardian"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Guardian"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/guardian-install.sh"
...
echo ""
echo -e "${GR}Guardian installation complete!${NC}"
echo ""
