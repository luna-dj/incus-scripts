#!/usr/bin/env bash
# install/pyload-install.sh — Pyload
...
msg_info "Loading upstream install script for Pyload"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/pyload-install.sh"
...
echo ""
echo -e "${GR}Pyload installation complete!${NC}"
echo ""
