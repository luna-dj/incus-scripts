#!/usr/bin/env bash
# install/xyops-install.sh — Xyops
...
msg_info "Loading upstream install script for Xyops"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/xyops-install.sh"
...
echo ""
echo -e "${GR}Xyops installation complete!${NC}"
echo ""
