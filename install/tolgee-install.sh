#!/usr/bin/env bash
# install/tolgee-install.sh — Tolgee
...
msg_info "Loading upstream install script for Tolgee"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/tolgee-install.sh"
...
echo ""
echo -e "${GR}Tolgee installation complete!${NC}"
echo ""
