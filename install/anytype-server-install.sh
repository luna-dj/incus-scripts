#!/usr/bin/env bash
# install/anytype-server-install.sh — Anytype Server
...
header_info "Anytype Server"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Anytype Server"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/anytype-server-install.sh"
...
echo ""
echo -e "${GR}Anytype Server installation complete!${NC}"
echo ""
