#!/usr/bin/env bash
# install/whisparr-install.sh — Whisparr
...
header_info "Whisparr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Whisparr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/whisparr-install.sh"
...
echo ""
echo -e "${GR}Whisparr installation complete!${NC}"
echo ""
