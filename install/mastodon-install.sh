#!/usr/bin/env bash
# install/mastodon-install.sh — Mastodon
...
header_info "Mastodon"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Mastodon"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/mastodon-install.sh"
...
echo ""
echo -e "${GR}Mastodon installation complete!${NC}"
echo ""
