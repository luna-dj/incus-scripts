#!/usr/bin/env bash
# install/mysql-install.sh — Mysql
...
msg_info "Loading upstream install script for Mysql"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/mysql-install.sh"
...
echo ""
echo -e "${GR}Mysql installation complete!${NC}"
echo ""
