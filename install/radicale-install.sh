#!/usr/bin/env bash
# install/radicale-install.sh — Radicale
...
header_info "Radicale"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Radicale"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/radicale-install.sh"
...
echo ""
echo -e "${GR}Radicale installation complete!${NC}"
echo ""
