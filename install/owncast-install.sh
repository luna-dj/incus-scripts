#!/usr/bin/env bash
# install/owncast-install.sh — Owncast
...
msg_info "Loading upstream install script for Owncast"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/owncast-install.sh"
...
echo ""
echo -e "${GR}Owncast installation complete!${NC}"
echo ""
