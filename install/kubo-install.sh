...
msg_info "Loading upstream install script for Kubo"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/kubo-install.sh"
...
echo ""
echo -e "${GR}Kubo installation complete!${NC}"
echo ""
