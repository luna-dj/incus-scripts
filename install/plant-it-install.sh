#!/usr/bin/env bash
# install/plant-it-install.sh — Plant It
...
header_info "Plant It"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Plant It"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/plant-it-install.sh"
...
echo ""
echo -e "${GR}Plant It installation complete!${NC}"
echo ""
