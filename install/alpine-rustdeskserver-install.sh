#!/usr/bin/env bash
# install/alpine-rustdeskserver-install.sh — Alpine Rustdeskserver
...
header_info "Alpine Rustdeskserver"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Rustdeskserver"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-rustdeskserver-install.sh"
...
echo ""
echo -e "${GR}Alpine Rustdeskserver installation complete!${NC}"
echo ""
