#!/usr/bin/env bash
# install/alpine-rclone-install.sh — Alpine Rclone
...
header_info "Alpine Rclone"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Rclone"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-rclone-install.sh"
...
echo ""
echo -e "${GR}Alpine Rclone installation complete!${NC}"
echo ""
