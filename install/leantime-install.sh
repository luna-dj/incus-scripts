#!/usr/bin/env bash
# install/leantime-install.sh — Leantime
...
header_info "Leantime"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Leantime"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/leantime-install.sh"
...
echo ""
echo -e "${GR}Leantime installation complete!${NC}"
echo ""
