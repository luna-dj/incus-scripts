#!/usr/bin/env bash
# install/passbolt-install.sh — Passbolt
...
header_info "Passbolt"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Passbolt"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/passbolt-install.sh"
...
echo ""
echo -e "${GR}Passbolt installation complete!${NC}"
echo ""
