#!/usr/bin/env bash
# install/authentik-install.sh — Authentik
...
header_info "Authentik"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Authentik"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/authentik-install.sh"
...
echo ""
echo -e "${GR}Authentik installation complete!${NC}"
echo ""
