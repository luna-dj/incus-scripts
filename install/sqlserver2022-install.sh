#!/usr/bin/env bash
# install/sqlserver2022-install.sh — Sqlserver2022
...
header_info "Sqlserver2022"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Sqlserver2022"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/sqlserver2022-install.sh"
...
echo ""
echo -e "${GR}Sqlserver2022 installation complete!${NC}"
echo ""
