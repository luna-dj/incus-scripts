#!/usr/bin/env bash
# install/minthcm-install.sh — Minthcm
...
msg_info "Loading upstream install script for Minthcm"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/minthcm-install.sh"
...
echo ""
echo -e "${GR}Minthcm installation complete!${NC}"
echo ""
