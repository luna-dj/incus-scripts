...
msg_info "Loading upstream install script for Grav"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/grav-install.sh"
...
echo ""
echo -e "${GR}Grav installation complete!${NC}"
echo ""
