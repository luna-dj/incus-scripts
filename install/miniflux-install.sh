#!/usr/bin/env bash
# install/miniflux-install.sh — Miniflux
...
header_info "Miniflux"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Miniflux"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/miniflux-install.sh"
...
echo ""
echo -e "${GR}Miniflux installation complete!${NC}"
echo ""
