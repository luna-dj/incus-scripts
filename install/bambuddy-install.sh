#!/usr/bin/env bash
# install/bambuddy-install.sh — Bambuddy
...
header_info "Bambuddy"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Bambuddy"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/bambuddy-install.sh"
...
echo ""
echo -e "${GR}Bambuddy installation complete!${NC}"
echo ""
