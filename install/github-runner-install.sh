#!/usr/bin/env bash
# install/github-runner-install.sh — Github Runner
...
header_info "Github Runner"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Github Runner"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/github-runner-install.sh"
...
echo ""
echo -e "${GR}Github Runner installation complete!${NC}"
echo ""
