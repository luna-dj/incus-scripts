#!/usr/bin/env bash
# install/alpine-rustypaste-install.sh — Alpine Rustypaste
...
header_info "Alpine Rustypaste"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Rustypaste"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-rustypaste-install.sh"
...
echo ""
echo -e "${GR}Alpine Rustypaste installation complete!${NC}"
echo ""
