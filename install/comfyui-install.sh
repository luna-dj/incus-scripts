#!/usr/bin/env bash
# install/comfyui-install.sh — Comfyui
...
msg_info "Loading upstream install script for Comfyui"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/comfyui-install.sh"
...
echo ""
echo -e "${GR}Comfyui installation complete!${NC}"
echo ""
