#!/usr/bin/env bash
# install/flaresolverr-install.sh — Flaresolverr
...
header_info "Flaresolverr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Flaresolverr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/flaresolverr-install.sh"
...
echo ""
echo -e "${GR}Flaresolverr installation complete!${NC}"
echo ""
