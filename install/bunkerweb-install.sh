#!/usr/bin/env bash
# install/bunkerweb-install.sh — Bunkerweb
...
header_info "Bunkerweb"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Bunkerweb"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/bunkerweb-install.sh"
...
echo ""
echo -e "${GR}Bunkerweb installation complete!${NC}"
echo ""
