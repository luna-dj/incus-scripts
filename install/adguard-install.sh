#!/usr/bin/env bash
# install/adguard-install.sh — Adguard
...
msg_info "Loading upstream install script for Adguard"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/adguard-install.sh"
...
echo ""
echo -e "${GR}Adguard installation complete!${NC}"
echo ""
