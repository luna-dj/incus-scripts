#!/usr/bin/env bash
# install/caddy-install.sh — Caddy
...
msg_info "Loading upstream install script for Caddy"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/caddy-install.sh"
...
echo ""
echo -e "${GR}Caddy installation complete!${NC}"
echo ""
