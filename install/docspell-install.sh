#!/usr/bin/env bash
# install/docspell-install.sh — Docspell
...
header_info "Docspell"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Docspell"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/docspell-install.sh"
...
echo ""
echo -e "${GR}Docspell installation complete!${NC}"
echo ""
