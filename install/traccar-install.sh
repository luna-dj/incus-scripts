#!/usr/bin/env bash
# install/traccar-install.sh — Traccar
...
msg_info "Loading upstream install script for Traccar"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/traccar-install.sh"
...
echo ""
echo -e "${GR}Traccar installation complete!${NC}"
echo ""
