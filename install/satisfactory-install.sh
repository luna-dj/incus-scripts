#!/usr/bin/env bash
# install/satisfactory-install.sh — Satisfactory
...
header_info "Satisfactory"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Satisfactory"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/satisfactory-install.sh"
...
echo ""
echo -e "${GR}Satisfactory installation complete!${NC}"
echo ""
