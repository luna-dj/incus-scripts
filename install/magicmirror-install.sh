#!/usr/bin/env bash
# install/magicmirror-install.sh — Magicmirror
...
header_info "Magicmirror"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Magicmirror"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/magicmirror-install.sh"
...
echo ""
echo -e "${GR}Magicmirror installation complete!${NC}"
echo ""
