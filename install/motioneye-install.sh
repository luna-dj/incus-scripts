#!/usr/bin/env bash
# install/motioneye-install.sh — Motioneye
...
header_info "Motioneye"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Motioneye"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/motioneye-install.sh"
...
echo ""
echo -e "${GR}Motioneye installation complete!${NC}"
echo ""
