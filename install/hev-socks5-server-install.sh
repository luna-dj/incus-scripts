#!/usr/bin/env bash
# install/hev-socks5-server-install.sh — Hev Socks5 Server
...
header_info "Hev Socks5 Server"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Hev Socks5 Server"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/hev-socks5-server-install.sh"
...
echo ""
echo -e "${GR}Hev Socks5 Server installation complete!${NC}"
echo ""
