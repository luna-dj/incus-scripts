#!/usr/bin/env bash
# install/drawdb-install.sh — Drawdb
...
msg_info "Loading upstream install script for Drawdb"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/drawdb-install.sh"
...
echo ""
echo -e "${GR}Drawdb installation complete!${NC}"
echo ""
