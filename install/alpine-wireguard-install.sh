#!/usr/bin/env bash
# install/alpine-wireguard-install.sh — Alpine Wireguard
...
header_info "Alpine Wireguard"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Wireguard"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-wireguard-install.sh"
...
echo ""
echo -e "${GR}Alpine Wireguard installation complete!${NC}"
echo ""
