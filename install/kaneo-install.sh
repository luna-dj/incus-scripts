#!/usr/bin/env bash
# install/kaneo-install.sh — Kaneo
...
msg_info "Loading upstream install script for Kaneo"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/kaneo-install.sh"
...
echo ""
echo -e "${GR}Kaneo installation complete!${NC}"
echo ""
