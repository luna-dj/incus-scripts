#!/usr/bin/env bash
# install/fileflows-install.sh — Fileflows
...
header_info "Fileflows"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Fileflows"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/fileflows-install.sh"
...
echo ""
echo -e "${GR}Fileflows installation complete!${NC}"
echo ""
