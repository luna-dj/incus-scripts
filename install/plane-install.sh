#!/usr/bin/env bash
# install/plane-install.sh — Plane
...
msg_info "Loading upstream install script for Plane"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/plane-install.sh"
...
echo ""
echo -e "${GR}Plane installation complete!${NC}"
echo ""
