...
msg_info "Loading upstream install script for Kan"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/kan-install.sh"
...
echo ""
echo -e "${GR}Kan installation complete!${NC}"
echo ""
