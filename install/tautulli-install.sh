#!/usr/bin/env bash
# install/tautulli-install.sh — Tautulli
...
header_info "Tautulli"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Tautulli"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/tautulli-install.sh"
...
echo ""
echo -e "${GR}Tautulli installation complete!${NC}"
echo ""
