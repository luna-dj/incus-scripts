#!/usr/bin/env bash
# install/semaphore-install.sh — Semaphore
...
header_info "Semaphore"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Semaphore"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/semaphore-install.sh"
...
echo ""
echo -e "${GR}Semaphore installation complete!${NC}"
echo ""
