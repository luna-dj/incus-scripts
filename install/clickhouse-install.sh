#!/usr/bin/env bash
# install/clickhouse-install.sh — Clickhouse
...
header_info "Clickhouse"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Clickhouse"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/clickhouse-install.sh"
...
echo ""
echo -e "${GR}Clickhouse installation complete!${NC}"
echo ""
