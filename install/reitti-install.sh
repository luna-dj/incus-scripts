#!/usr/bin/env bash
# install/reitti-install.sh — Reitti
...
msg_info "Loading upstream install script for Reitti"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/reitti-install.sh"
...
echo ""
echo -e "${GR}Reitti installation complete!${NC}"
echo ""
