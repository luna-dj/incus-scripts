#!/usr/bin/env bash
# install/bookorbit-install.sh — Bookorbit
...
header_info "Bookorbit"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Bookorbit"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/bookorbit-install.sh"
...
echo ""
echo -e "${GR}Bookorbit installation complete!${NC}"
echo ""
