#!/usr/bin/env bash
# install/inventree-install.sh — Inventree
...
header_info "Inventree"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Inventree"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/inventree-install.sh"
...
echo ""
echo -e "${GR}Inventree installation complete!${NC}"
echo ""
