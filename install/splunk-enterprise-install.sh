#!/usr/bin/env bash
# install/splunk-enterprise-install.sh — Splunk Enterprise
...
header_info "Splunk Enterprise"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Splunk Enterprise"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/splunk-enterprise-install.sh"
...
echo ""
echo -e "${GR}Splunk Enterprise installation complete!${NC}"
echo ""
