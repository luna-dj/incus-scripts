#!/usr/bin/env bash
# install/soulsync-install.sh — Soulsync
...
header_info "Soulsync"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Soulsync"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/soulsync-install.sh"
...
echo ""
echo -e "${GR}Soulsync installation complete!${NC}"
echo ""
