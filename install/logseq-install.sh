#!/usr/bin/env bash
# install/logseq-install.sh — Logseq
...
msg_info "Loading upstream install script for Logseq"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/logseq-install.sh"
...
echo ""
echo -e "${GR}Logseq installation complete!${NC}"
echo ""
