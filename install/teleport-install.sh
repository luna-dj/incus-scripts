#!/usr/bin/env bash
# install/teleport-install.sh — Teleport
...
header_info "Teleport"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Teleport"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/teleport-install.sh"
...
echo ""
echo -e "${GR}Teleport installation complete!${NC}"
echo ""
