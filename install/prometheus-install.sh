#!/usr/bin/env bash
# install/prometheus-install.sh — Prometheus
...
header_info "Prometheus"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Prometheus"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/prometheus-install.sh"
...
echo ""
echo -e "${GR}Prometheus installation complete!${NC}"
echo ""
