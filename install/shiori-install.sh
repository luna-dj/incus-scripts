#!/usr/bin/env bash
# install/shiori-install.sh — Shiori
...
msg_info "Loading upstream install script for Shiori"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/shiori-install.sh"
...
echo ""
echo -e "${GR}Shiori installation complete!${NC}"
echo ""
