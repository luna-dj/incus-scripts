...
msg_info "Loading upstream install script for Neko"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/neko-install.sh"
...
echo ""
echo -e "${GR}Neko installation complete!${NC}"
echo ""
