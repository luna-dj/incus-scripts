#!/usr/bin/env bash
# install/pihole-install.sh — Pihole
...
msg_info "Loading upstream install script for Pihole"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/pihole-install.sh"
...
echo ""
echo -e "${GR}Pihole installation complete!${NC}"
echo ""
