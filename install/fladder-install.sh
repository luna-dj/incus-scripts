#!/usr/bin/env bash
# install/fladder-install.sh — Fladder
...
msg_info "Loading upstream install script for Fladder"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/fladder-install.sh"
...
echo ""
echo -e "${GR}Fladder installation complete!${NC}"
echo ""
