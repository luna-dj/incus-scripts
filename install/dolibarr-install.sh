#!/usr/bin/env bash
# install/dolibarr-install.sh — Dolibarr
...
header_info "Dolibarr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Dolibarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/dolibarr-install.sh"
...
echo ""
echo -e "${GR}Dolibarr installation complete!${NC}"
echo ""
