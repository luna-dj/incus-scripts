#!/usr/bin/env bash
# install/healthchecks-install.sh — Healthchecks
...
header_info "Healthchecks"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Healthchecks"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/healthchecks-install.sh"
...
echo ""
echo -e "${GR}Healthchecks installation complete!${NC}"
echo ""
