#!/usr/bin/env bash
# install/nextexplorer-install.sh — Nextexplorer
...
header_info "Nextexplorer"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Nextexplorer"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/nextexplorer-install.sh"
...
echo ""
echo -e "${GR}Nextexplorer installation complete!${NC}"
echo ""
