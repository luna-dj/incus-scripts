#!/usr/bin/env bash
# install/verdaccio-install.sh — Verdaccio
...
header_info "Verdaccio"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Verdaccio"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/verdaccio-install.sh"
...
echo ""
echo -e "${GR}Verdaccio installation complete!${NC}"
echo ""
