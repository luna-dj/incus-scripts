#!/usr/bin/env bash
# install/transmission-install.sh — Transmission
...
header_info "Transmission"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Transmission"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/transmission-install.sh"
...
echo ""
echo -e "${GR}Transmission installation complete!${NC}"
echo ""
