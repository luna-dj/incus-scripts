#!/usr/bin/env bash
# install/gokapi-install.sh — Gokapi
...
msg_info "Loading upstream install script for Gokapi"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/gokapi-install.sh"
...
echo ""
echo -e "${GR}Gokapi installation complete!${NC}"
echo ""
