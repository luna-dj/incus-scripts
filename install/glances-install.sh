#!/usr/bin/env bash
# install/glances-install.sh — Glances (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Glances addon)"
  setup_docker
  msg_ok "Docker installed"
fi

msg_info "Loading upstream addon script for Glances"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/glances.sh"
...
echo ""
echo -e "${GR}Glances installation complete!${NC}"
echo ""
