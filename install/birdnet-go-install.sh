#!/usr/bin/env bash
# install/birdnet-go-install.sh — Birdnet Go
...
header_info "Birdnet Go"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Birdnet Go"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/birdnet-go-install.sh"
...
echo ""
echo -e "${GR}Birdnet Go installation complete!${NC}"
echo ""
