#!/usr/bin/env bash
# install/alpine-prometheus-install.sh — Alpine Prometheus
...
header_info "Alpine Prometheus"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Prometheus"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-prometheus-install.sh"
...
echo ""
echo -e "${GR}Alpine Prometheus installation complete!${NC}"
echo ""
