#!/usr/bin/env bash
# install/centos-install.sh — Centos
...
msg_info "Loading upstream install script for Centos"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/centos-install.sh"
...
echo ""
echo -e "${GR}Centos installation complete!${NC}"
echo ""
