#!/usr/bin/env bash
# install/elementsynapse-install.sh — Elementsynapse
...
header_info "Elementsynapse"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Elementsynapse"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/elementsynapse-install.sh"
...
echo ""
echo -e "${GR}Elementsynapse installation complete!${NC}"
echo ""
