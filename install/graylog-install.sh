#!/usr/bin/env bash
# install/graylog-install.sh — Graylog
...
msg_info "Loading upstream install script for Graylog"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/graylog-install.sh"
...
echo ""
echo -e "${GR}Graylog installation complete!${NC}"
echo ""
