#!/usr/bin/env bash
# install/investbrain-install.sh — Investbrain
...
header_info "Investbrain"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Investbrain"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/investbrain-install.sh"
...
echo ""
echo -e "${GR}Investbrain installation complete!${NC}"
echo ""
