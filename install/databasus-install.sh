#!/usr/bin/env bash
# install/databasus-install.sh — Databasus
...
header_info "Databasus"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Databasus"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/databasus-install.sh"
...
echo ""
echo -e "${GR}Databasus installation complete!${NC}"
echo ""
