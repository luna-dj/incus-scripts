#!/usr/bin/env bash
# install/redis-install.sh — Redis
...
msg_info "Loading upstream install script for Redis"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/redis-install.sh"
...
echo ""
echo -e "${GR}Redis installation complete!${NC}"
echo ""
