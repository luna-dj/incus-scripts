#!/usr/bin/env bash
# install/pelican-wings-install.sh — Pelican Wings
...
header_info "Pelican Wings"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Pelican Wings"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/pelican-wings-install.sh"
...
echo ""
echo -e "${GR}Pelican Wings installation complete!${NC}"
echo ""
