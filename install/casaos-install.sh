#!/usr/bin/env bash
# install/casaos-install.sh — Casaos
...
msg_info "Loading upstream install script for Casaos"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/casaos-install.sh"
...
echo ""
echo -e "${GR}Casaos installation complete!${NC}"
echo ""
