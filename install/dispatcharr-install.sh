#!/usr/bin/env bash
# install/dispatcharr-install.sh — Dispatcharr
...
header_info "Dispatcharr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Dispatcharr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/dispatcharr-install.sh"
...
echo ""
echo -e "${GR}Dispatcharr installation complete!${NC}"
echo ""
