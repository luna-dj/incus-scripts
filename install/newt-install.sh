...
msg_info "Loading upstream install script for Newt"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/newt-install.sh"
...
echo ""
echo -e "${GR}Newt installation complete!${NC}"
echo ""
