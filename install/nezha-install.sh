#!/usr/bin/env bash
# install/nezha-install.sh — Nezha
...
msg_info "Loading upstream install script for Nezha"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/nezha-install.sh"
...
echo ""
echo -e "${GR}Nezha installation complete!${NC}"
echo ""
