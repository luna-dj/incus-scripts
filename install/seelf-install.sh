#!/usr/bin/env bash
# install/seelf-install.sh — Seelf
...
msg_info "Loading upstream install script for Seelf"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/seelf-install.sh"
...
echo ""
echo -e "${GR}Seelf installation complete!${NC}"
echo ""
