#!/usr/bin/env bash
# install/watcharr-install.sh — Watcharr
...
header_info "Watcharr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Watcharr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/watcharr-install.sh"
...
echo ""
echo -e "${GR}Watcharr installation complete!${NC}"
echo ""
