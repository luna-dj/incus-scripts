#!/usr/bin/env bash
# install/lemonade-server-install.sh — Lemonade Server
...
header_info "Lemonade Server"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Lemonade Server"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/lemonade-server-install.sh"
...
echo ""
echo -e "${GR}Lemonade Server installation complete!${NC}"
echo ""
