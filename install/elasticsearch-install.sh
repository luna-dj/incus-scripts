#!/usr/bin/env bash
# install/elasticsearch-install.sh — Elasticsearch
...
header_info "Elasticsearch"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Elasticsearch"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/elasticsearch-install.sh"
...
echo ""
echo -e "${GR}Elasticsearch installation complete!${NC}"
echo ""
