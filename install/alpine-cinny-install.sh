#!/usr/bin/env bash
# install/alpine-cinny-install.sh — Alpine Cinny
...
header_info "Alpine Cinny"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Cinny"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-cinny-install.sh"
...
echo ""
echo -e "${GR}Alpine Cinny installation complete!${NC}"
echo ""
