#!/usr/bin/env bash
# install/whisparr-eros-install.sh — Whisparr Eros
...
header_info "Whisparr Eros"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Whisparr Eros"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/whisparr-eros-install.sh"
...
echo ""
echo -e "${GR}Whisparr Eros installation complete!${NC}"
echo ""
