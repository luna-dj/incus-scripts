#!/usr/bin/env bash
# install/ubuntu-install.sh — Ubuntu
...
msg_info "Loading upstream install script for Ubuntu"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/ubuntu-install.sh"
...
echo ""
echo -e "${GR}Ubuntu installation complete!${NC}"
echo ""
