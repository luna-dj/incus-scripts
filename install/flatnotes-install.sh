#!/usr/bin/env bash
# install/flatnotes-install.sh — Flatnotes
...
header_info "Flatnotes"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Flatnotes"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/flatnotes-install.sh"
...
echo ""
echo -e "${GR}Flatnotes installation complete!${NC}"
echo ""
