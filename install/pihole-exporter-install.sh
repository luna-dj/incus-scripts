#!/usr/bin/env bash
# install/pihole-exporter-install.sh — Pihole Exporter (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Pihole Exporter addon)"
  setup_docker
  msg_ok "Docker installed"
fi

msg_info "Loading upstream addon script for Pihole Exporter"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/pihole-exporter.sh"
...
echo ""
echo -e "${GR}Pihole Exporter installation complete!${NC}"
echo ""
