#!/usr/bin/env bash
# install/wallabag-install.sh — Wallabag
...
header_info "Wallabag"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Wallabag"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/wallabag-install.sh"
...
echo ""
echo -e "${GR}Wallabag installation complete!${NC}"
echo ""
