#!/usr/bin/env bash
# install/patchmon-install.sh — Patchmon
...
header_info "Patchmon"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Patchmon"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/patchmon-install.sh"
...
echo ""
echo -e "${GR}Patchmon installation complete!${NC}"
echo ""
