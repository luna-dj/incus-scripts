#!/usr/bin/env bash
# install/leafwiki-install.sh — Leafwiki
...
header_info "Leafwiki"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Leafwiki"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/leafwiki-install.sh"
...
echo ""
echo -e "${GR}Leafwiki installation complete!${NC}"
echo ""
