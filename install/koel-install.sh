...
msg_info "Loading upstream install script for Koel"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/koel-install.sh"
...
echo ""
echo -e "${GR}Koel installation complete!${NC}"
echo ""
