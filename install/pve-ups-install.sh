#!/usr/bin/env bash
# install/pve-ups-install.sh — Pve Ups
...
msg_info "Loading upstream install script for Pve Ups"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/pve-ups-install.sh"
...
echo ""
echo -e "${GR}Pve Ups installation complete!${NC}"
echo ""
