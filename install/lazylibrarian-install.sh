#!/usr/bin/env bash
# install/lazylibrarian-install.sh — Lazylibrarian
...
header_info "Lazylibrarian"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Lazylibrarian"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/lazylibrarian-install.sh"
...
echo ""
echo -e "${GR}Lazylibrarian installation complete!${NC}"
echo ""
