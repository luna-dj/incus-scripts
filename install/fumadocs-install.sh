#!/usr/bin/env bash
# install/fumadocs-install.sh — Fumadocs
...
header_info "Fumadocs"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Fumadocs"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/fumadocs-install.sh"
...
echo ""
echo -e "${GR}Fumadocs installation complete!${NC}"
echo ""
