#!/usr/bin/env bash
# install/add-netbird-lxc-install.sh — Add Netbird Lxc (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Add Netbird Lxc addon)"
  setup_docker
...
msg_info "Loading upstream addon script for Add Netbird Lxc"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/add-netbird-lxc.sh"
...
echo ""
echo -e "${GR}Add Netbird Lxc installation complete!${NC}"
echo ""
