#!/usr/bin/env bash
# install/endurain-install.sh — Endurain
...
header_info "Endurain"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Endurain"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/endurain-install.sh"
...
echo ""
echo -e "${GR}Endurain installation complete!${NC}"
echo ""
