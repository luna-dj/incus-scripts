#!/usr/bin/env bash
# install/arcane-install.sh — Arcane (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Arcane addon)"
  setup_docker
...
msg_info "Loading upstream addon script for Arcane"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/arcane.sh"
...
echo ""
echo -e "${GR}Arcane installation complete!${NC}"
echo ""
