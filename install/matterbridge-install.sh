#!/usr/bin/env bash
# install/matterbridge-install.sh — Matterbridge
...
header_info "Matterbridge"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Matterbridge"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/matterbridge-install.sh"
...
echo ""
echo -e "${GR}Matterbridge installation complete!${NC}"
echo ""
