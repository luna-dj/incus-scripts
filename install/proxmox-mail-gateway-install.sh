#!/usr/bin/env bash
# install/proxmox-mail-gateway-install.sh — Proxmox Mail Gateway
...
header_info "Proxmox Mail Gateway"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Proxmox Mail Gateway"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/proxmox-mail-gateway-install.sh"
...
echo ""
echo -e "${GR}Proxmox Mail Gateway installation complete!${NC}"
echo ""
