#!/usr/bin/env bash
# install/musicseerr-install.sh — Musicseerr
...
header_info "Musicseerr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Musicseerr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/musicseerr-install.sh"
...
echo ""
echo -e "${GR}Musicseerr installation complete!${NC}"
echo ""
