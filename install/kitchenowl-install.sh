#!/usr/bin/env bash
# install/kitchenowl-install.sh — Kitchenowl
...
header_info "Kitchenowl"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Kitchenowl"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/kitchenowl-install.sh"
...
echo ""
echo -e "${GR}Kitchenowl installation complete!${NC}"
echo ""
