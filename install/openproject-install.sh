#!/usr/bin/env bash
# install/openproject-install.sh — Openproject
...
header_info "Openproject"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Openproject"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/openproject-install.sh"
...
echo ""
echo -e "${GR}Openproject installation complete!${NC}"
echo ""
