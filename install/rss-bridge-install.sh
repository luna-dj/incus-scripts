#!/usr/bin/env bash
# install/rss-bridge-install.sh — Rss Bridge
...
header_info "Rss Bridge"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Rss Bridge"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/rss-bridge-install.sh"
...
echo ""
echo -e "${GR}Rss Bridge installation complete!${NC}"
echo ""
