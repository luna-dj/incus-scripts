#!/usr/bin/env bash
# install/bazarr-install.sh — Bazarr
...
msg_info "Loading upstream install script for Bazarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/bazarr-install.sh"
...
echo ""
echo -e "${GR}Bazarr installation complete!${NC}"
echo ""
