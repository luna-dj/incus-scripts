#!/usr/bin/env bash
# install/matomo-install.sh — Matomo
...
msg_info "Loading upstream install script for Matomo"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/matomo-install.sh"
...
echo ""
echo -e "${GR}Matomo installation complete!${NC}"
echo ""
