...
msg_info "Loading upstream install script for Odoo"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/odoo-install.sh"
...
echo ""
echo -e "${GR}Odoo installation complete!${NC}"
echo ""
