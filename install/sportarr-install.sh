#!/usr/bin/env bash
# install/sportarr-install.sh — Sportarr
...
header_info "Sportarr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Sportarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/sportarr-install.sh"
...
echo ""
echo -e "${GR}Sportarr installation complete!${NC}"
echo ""
