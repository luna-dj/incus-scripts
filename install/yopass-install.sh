#!/usr/bin/env bash
# install/yopass-install.sh — Yopass
...
msg_info "Loading upstream install script for Yopass"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/yopass-install.sh"
...
echo ""
echo -e "${GR}Yopass installation complete!${NC}"
echo ""
