#!/usr/bin/env bash
# install/wizarr-install.sh — Wizarr
...
msg_info "Loading upstream install script for Wizarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/wizarr-install.sh"
...
echo ""
echo -e "${GR}Wizarr installation complete!${NC}"
echo ""
