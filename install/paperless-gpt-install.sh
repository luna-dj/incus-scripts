#!/usr/bin/env bash
# install/paperless-gpt-install.sh — Paperless Gpt
...
header_info "Paperless Gpt"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Paperless Gpt"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/paperless-gpt-install.sh"
...
echo ""
echo -e "${GR}Paperless Gpt installation complete!${NC}"
echo ""
