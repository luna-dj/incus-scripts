#!/usr/bin/env bash
# install/alpine-vaultwarden-install.sh — Alpine Vaultwarden
...
header_info "Alpine Vaultwarden"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Vaultwarden"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-vaultwarden-install.sh"
...
echo ""
echo -e "${GR}Alpine Vaultwarden installation complete!${NC}"
echo ""
