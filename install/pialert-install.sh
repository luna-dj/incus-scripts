#!/usr/bin/env bash
# install/pialert-install.sh — Pialert
...
msg_info "Loading upstream install script for Pialert"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/pialert-install.sh"
...
echo ""
echo -e "${GR}Pialert installation complete!${NC}"
echo ""
