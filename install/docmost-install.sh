#!/usr/bin/env bash
# install/docmost-install.sh — Docmost
...
msg_info "Loading upstream install script for Docmost"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/docmost-install.sh"
...
echo ""
echo -e "${GR}Docmost installation complete!${NC}"
echo ""
