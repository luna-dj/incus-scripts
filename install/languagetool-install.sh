#!/usr/bin/env bash
# install/languagetool-install.sh — Languagetool
...
header_info "Languagetool"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Languagetool"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/languagetool-install.sh"
...
echo ""
echo -e "${GR}Languagetool installation complete!${NC}"
echo ""
