#!/usr/bin/env bash
# install/prometheus-pve-exporter-install.sh — Prometheus Pve Exporter
...
header_info "Prometheus Pve Exporter"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Prometheus Pve Exporter"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/prometheus-pve-exporter-install.sh"
...
echo ""
echo -e "${GR}Prometheus Pve Exporter installation complete!${NC}"
echo ""
