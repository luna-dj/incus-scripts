#!/usr/bin/env bash
# install/foldergram-install.sh — Foldergram
...
header_info "Foldergram"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Foldergram"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/foldergram-install.sh"
...
echo ""
echo -e "${GR}Foldergram installation complete!${NC}"
echo ""
