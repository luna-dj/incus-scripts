#!/usr/bin/env bash
# install/opensuse-install.sh — Opensuse
...
header_info "Opensuse"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Opensuse"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/opensuse-install.sh"
...
echo ""
echo -e "${GR}Opensuse installation complete!${NC}"
echo ""
