#!/usr/bin/env bash
# install/ghost-install.sh — Ghost
...
msg_info "Loading upstream install script for Ghost"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/ghost-install.sh"
...
echo ""
echo -e "${GR}Ghost installation complete!${NC}"
echo ""
