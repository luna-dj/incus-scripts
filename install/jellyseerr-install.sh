#!/usr/bin/env bash
# install/jellyseerr-install.sh — Jellyseerr
...
header_info "Jellyseerr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Jellyseerr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/jellyseerr-install.sh"
...
echo ""
echo -e "${GR}Jellyseerr installation complete!${NC}"
echo ""
