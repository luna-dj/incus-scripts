#!/usr/bin/env bash
# install/nextpvr-install.sh — Nextpvr
...
msg_info "Loading upstream install script for Nextpvr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/nextpvr-install.sh"
...
echo ""
echo -e "${GR}Nextpvr installation complete!${NC}"
echo ""
