#!/usr/bin/env bash
# install/joplin-server-install.sh — Joplin Server
...
header_info "Joplin Server"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Joplin Server"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/joplin-server-install.sh"
...
echo ""
echo -e "${GR}Joplin Server installation complete!${NC}"
echo ""
