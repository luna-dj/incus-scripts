#!/usr/bin/env bash
# install/itsm-ng-install.sh — Itsm Ng
...
msg_info "Loading upstream install script for Itsm Ng"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/itsm-ng-install.sh"
...
echo ""
echo -e "${GR}Itsm Ng installation complete!${NC}"
echo ""
