#!/usr/bin/env bash
# install/sync-in-install.sh — Sync In
...
msg_info "Loading upstream install script for Sync In"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/sync-in-install.sh"
...
echo ""
echo -e "${GR}Sync In installation complete!${NC}"
echo ""
