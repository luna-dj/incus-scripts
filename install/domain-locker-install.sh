#!/usr/bin/env bash
# install/domain-locker-install.sh — Domain Locker
...
header_info "Domain Locker"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Domain Locker"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/domain-locker-install.sh"
...
echo ""
echo -e "${GR}Domain Locker installation complete!${NC}"
echo ""
