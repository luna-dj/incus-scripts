#!/usr/bin/env bash
# install/alpine-valkey-install.sh — Alpine Valkey
...
header_info "Alpine Valkey"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Valkey"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-valkey-install.sh"
...
echo ""
echo -e "${GR}Alpine Valkey installation complete!${NC}"
echo ""
