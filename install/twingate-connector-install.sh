#!/usr/bin/env bash
# install/twingate-connector-install.sh — Twingate Connector
...
header_info "Twingate Connector"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Twingate Connector"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/twingate-connector-install.sh"
...
echo ""
echo -e "${GR}Twingate Connector installation complete!${NC}"
echo ""
