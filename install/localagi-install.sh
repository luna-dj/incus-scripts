#!/usr/bin/env bash
# install/localagi-install.sh — Localagi
...
header_info "Localagi"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Localagi"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/localagi-install.sh"
...
echo ""
echo -e "${GR}Localagi installation complete!${NC}"
echo ""
