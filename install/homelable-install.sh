#!/usr/bin/env bash
# install/homelable-install.sh — Homelable
...
header_info "Homelable"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Homelable"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/homelable-install.sh"
...
echo ""
echo -e "${GR}Homelable installation complete!${NC}"
echo ""
