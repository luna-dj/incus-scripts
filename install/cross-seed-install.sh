#!/usr/bin/env bash
# install/cross-seed-install.sh — Cross Seed
...
header_info "Cross Seed"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Cross Seed"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/cross-seed-install.sh"
...
echo ""
echo -e "${GR}Cross Seed installation complete!${NC}"
echo ""
