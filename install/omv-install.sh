...
msg_info "Loading upstream install script for Omv"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/omv-install.sh"
...
echo ""
echo -e "${GR}Omv installation complete!${NC}"
echo ""
