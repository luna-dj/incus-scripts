#!/usr/bin/env bash
# install/heimdall-dashboard-install.sh — Heimdall Dashboard
...
header_info "Heimdall Dashboard"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Heimdall Dashboard"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/heimdall-dashboard-install.sh"
...
echo ""
echo -e "${GR}Heimdall Dashboard installation complete!${NC}"
echo ""
