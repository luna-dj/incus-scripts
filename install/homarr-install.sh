#!/usr/bin/env bash
# install/homarr-install.sh — Homarr
...
msg_info "Loading upstream install script for Homarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/homarr-install.sh"
...
echo ""
echo -e "${GR}Homarr installation complete!${NC}"
echo ""
