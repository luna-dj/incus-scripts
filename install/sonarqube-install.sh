#!/usr/bin/env bash
# install/sonarqube-install.sh — Sonarqube
...
header_info "Sonarqube"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Sonarqube"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/sonarqube-install.sh"
...
echo ""
echo -e "${GR}Sonarqube installation complete!${NC}"
echo ""
