#!/usr/bin/env bash
# install/alpine-bitmagnet-install.sh — Alpine Bitmagnet
...
header_info "Alpine Bitmagnet"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Bitmagnet"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-bitmagnet-install.sh"
...
echo ""
echo -e "${GR}Alpine Bitmagnet installation complete!${NC}"
echo ""
