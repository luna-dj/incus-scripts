#!/usr/bin/env bash
# install/fedora-install.sh — Fedora
...
msg_info "Loading upstream install script for Fedora"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/fedora-install.sh"
...
echo ""
echo -e "${GR}Fedora installation complete!${NC}"
echo ""
