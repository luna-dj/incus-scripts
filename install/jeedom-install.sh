#!/usr/bin/env bash
# install/jeedom-install.sh — Jeedom
...
msg_info "Loading upstream install script for Jeedom"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/jeedom-install.sh"
...
echo ""
echo -e "${GR}Jeedom installation complete!${NC}"
echo ""
