#!/usr/bin/env bash
# install/kima-hub-install.sh — Kima Hub
...
header_info "Kima Hub"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Kima Hub"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/kima-hub-install.sh"
...
echo ""
echo -e "${GR}Kima Hub installation complete!${NC}"
echo ""
