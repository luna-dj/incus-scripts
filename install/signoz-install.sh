#!/usr/bin/env bash
# install/signoz-install.sh — Signoz
...
msg_info "Loading upstream install script for Signoz"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/signoz-install.sh"
...
echo ""
echo -e "${GR}Signoz installation complete!${NC}"
echo ""
