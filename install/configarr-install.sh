#!/usr/bin/env bash
# install/configarr-install.sh — Configarr
...
header_info "Configarr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Configarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/configarr-install.sh"
...
echo ""
echo -e "${GR}Configarr installation complete!${NC}"
echo ""
