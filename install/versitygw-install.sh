#!/usr/bin/env bash
# install/versitygw-install.sh — Versitygw
...
header_info "Versitygw"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Versitygw"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/versitygw-install.sh"
...
echo ""
echo -e "${GR}Versitygw installation complete!${NC}"
echo ""
