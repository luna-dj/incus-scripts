#!/usr/bin/env bash
# install/squid-install.sh — Squid
...
msg_info "Loading upstream install script for Squid"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/squid-install.sh"
...
echo ""
echo -e "${GR}Squid installation complete!${NC}"
echo ""
