#!/usr/bin/env bash
# install/lubelogger-install.sh — Lubelogger
...
header_info "Lubelogger"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Lubelogger"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/lubelogger-install.sh"
...
echo ""
echo -e "${GR}Lubelogger installation complete!${NC}"
echo ""
