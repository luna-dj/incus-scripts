#!/usr/bin/env bash
# install/radarr-install.sh — Radarr
...
msg_info "Loading upstream install script for Radarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/radarr-install.sh"
...
echo ""
echo -e "${GR}Radarr installation complete!${NC}"
echo ""
