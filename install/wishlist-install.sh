#!/usr/bin/env bash
# install/wishlist-install.sh — Wishlist
...
header_info "Wishlist"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Wishlist"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/wishlist-install.sh"
...
echo ""
echo -e "${GR}Wishlist installation complete!${NC}"
echo ""
