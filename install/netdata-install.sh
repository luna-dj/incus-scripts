#!/usr/bin/env bash
# install/netdata-install.sh — Netdata (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Netdata addon)"
  setup_docker
...
msg_info "Loading upstream addon script for Netdata"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/netdata.sh"
...
echo ""
echo -e "${GR}Netdata installation complete!${NC}"
echo ""
