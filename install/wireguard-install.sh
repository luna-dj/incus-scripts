#!/usr/bin/env bash
# install/wireguard-install.sh — Wireguard
...
header_info "Wireguard"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Wireguard"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/wireguard-install.sh"
...
echo ""
echo -e "${GR}Wireguard installation complete!${NC}"
echo ""
