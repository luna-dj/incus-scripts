#!/usr/bin/env bash
# install/lingarr-install.sh — Lingarr
...
msg_info "Loading upstream install script for Lingarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/lingarr-install.sh"
...
echo ""
echo -e "${GR}Lingarr installation complete!${NC}"
echo ""
