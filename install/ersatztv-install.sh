#!/usr/bin/env bash
# install/ersatztv-install.sh — Ersatztv
...
header_info "Ersatztv"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Ersatztv"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/ersatztv-install.sh"
...
echo ""
echo -e "${GR}Ersatztv installation complete!${NC}"
echo ""
