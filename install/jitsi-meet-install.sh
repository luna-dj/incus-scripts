#!/usr/bin/env bash
# install/jitsi-meet-install.sh — Jitsi Meet
...
header_info "Jitsi Meet"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Jitsi Meet"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/jitsi-meet-install.sh"
...
echo ""
echo -e "${GR}Jitsi Meet installation complete!${NC}"
echo ""
