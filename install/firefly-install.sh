#!/usr/bin/env bash
# install/firefly-install.sh — Firefly
...
msg_info "Loading upstream install script for Firefly"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/firefly-install.sh"
...
echo ""
echo -e "${GR}Firefly installation complete!${NC}"
echo ""
