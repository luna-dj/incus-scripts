#!/usr/bin/env bash
# install/qbittorrent-install.sh — Qbittorrent
...
header_info "Qbittorrent"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Qbittorrent"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/qbittorrent-install.sh"
...
echo ""
echo -e "${GR}Qbittorrent installation complete!${NC}"
echo ""
