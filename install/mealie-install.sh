#!/usr/bin/env bash
# install/mealie-install.sh — Mealie
...
msg_info "Loading upstream install script for Mealie"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/mealie-install.sh"
...
echo ""
echo -e "${GR}Mealie installation complete!${NC}"
echo ""
