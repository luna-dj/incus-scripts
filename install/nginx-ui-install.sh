#!/usr/bin/env bash
# install/nginx-ui-install.sh — Nginx Ui
...
header_info "Nginx Ui"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Nginx Ui"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/nginx-ui-install.sh"
...
echo ""
echo -e "${GR}Nginx Ui installation complete!${NC}"
echo ""
