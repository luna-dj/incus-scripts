#!/usr/bin/env bash
# install/dockhand-install.sh — Dockhand (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Dockhand addon)"
  setup_docker
...
msg_info "Loading upstream addon script for Dockhand"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/dockhand.sh"
...
echo ""
echo -e "${GR}Dockhand installation complete!${NC}"
echo ""
