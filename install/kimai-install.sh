#!/usr/bin/env bash
# install/kimai-install.sh — Kimai
...
msg_info "Loading upstream install script for Kimai"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/kimai-install.sh"
...
echo ""
echo -e "${GR}Kimai installation complete!${NC}"
echo ""
