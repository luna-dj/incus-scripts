#!/usr/bin/env bash
# install/octoprint-install.sh — Octoprint
...
header_info "Octoprint"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Octoprint"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/octoprint-install.sh"
...
echo ""
echo -e "${GR}Octoprint installation complete!${NC}"
echo ""
