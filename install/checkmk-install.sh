#!/usr/bin/env bash
# install/checkmk-install.sh — Checkmk
...
msg_info "Loading upstream install script for Checkmk"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/checkmk-install.sh"
...
echo ""
echo -e "${GR}Checkmk installation complete!${NC}"
echo ""
