#!/usr/bin/env bash
# install/rclone-install.sh — Rclone
...
msg_info "Loading upstream install script for Rclone"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/rclone-install.sh"
...
echo ""
echo -e "${GR}Rclone installation complete!${NC}"
echo ""
