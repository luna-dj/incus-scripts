#!/usr/bin/env bash
# install/gotify-install.sh — Gotify
...
msg_info "Loading upstream install script for Gotify"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/gotify-install.sh"
...
echo ""
echo -e "${GR}Gotify installation complete!${NC}"
echo ""
