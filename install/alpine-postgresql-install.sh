#!/usr/bin/env bash
# install/alpine-postgresql-install.sh — Alpine Postgresql
...
header_info "Alpine Postgresql"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Postgresql"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-postgresql-install.sh"
...
echo ""
echo -e "${GR}Alpine Postgresql installation complete!${NC}"
echo ""
