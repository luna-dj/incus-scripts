#!/usr/bin/env bash
# install/yourls-install.sh — Yourls
...
msg_info "Loading upstream install script for Yourls"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/yourls-install.sh"
...
echo ""
echo -e "${GR}Yourls installation complete!${NC}"
echo ""
