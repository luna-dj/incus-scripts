#!/usr/bin/env bash
# install/lidarr-install.sh — Lidarr
...
msg_info "Loading upstream install script for Lidarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/lidarr-install.sh"
...
echo ""
echo -e "${GR}Lidarr installation complete!${NC}"
echo ""
