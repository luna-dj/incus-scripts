#!/usr/bin/env bash
# install/alpine-adguard-install.sh — Alpine Adguard
...
header_info "Alpine Adguard"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Adguard"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-adguard-install.sh"
...
echo ""
echo -e "${GR}Alpine Adguard installation complete!${NC}"
echo ""
