#!/usr/bin/env bash
# install/coredns-install.sh — Coredns
...
msg_info "Loading upstream install script for Coredns"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/coredns-install.sh"
...
echo ""
echo -e "${GR}Coredns installation complete!${NC}"
echo ""
