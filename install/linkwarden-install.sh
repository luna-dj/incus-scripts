#!/usr/bin/env bash
# install/linkwarden-install.sh — Linkwarden
...
header_info "Linkwarden"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Linkwarden"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/linkwarden-install.sh"
...
echo ""
echo -e "${GR}Linkwarden installation complete!${NC}"
echo ""
