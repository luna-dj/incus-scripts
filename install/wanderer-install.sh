#!/usr/bin/env bash
# install/wanderer-install.sh — Wanderer
...
header_info "Wanderer"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Wanderer"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/wanderer-install.sh"
...
echo ""
echo -e "${GR}Wanderer installation complete!${NC}"
echo ""
