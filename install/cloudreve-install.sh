#!/usr/bin/env bash
# install/cloudreve-install.sh — Cloudreve
...
header_info "Cloudreve"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Cloudreve"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/cloudreve-install.sh"
...
echo ""
echo -e "${GR}Cloudreve installation complete!${NC}"
echo ""
