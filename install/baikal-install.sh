#!/usr/bin/env bash
# install/baikal-install.sh — Baikal
...
msg_info "Loading upstream install script for Baikal"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/baikal-install.sh"
...
echo ""
echo -e "${GR}Baikal installation complete!${NC}"
echo ""
