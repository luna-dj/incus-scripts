#!/usr/bin/env bash
# install/homer-install.sh — Homer
...
msg_info "Loading upstream install script for Homer"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/homer-install.sh"
...
echo ""
echo -e "${GR}Homer installation complete!${NC}"
echo ""
