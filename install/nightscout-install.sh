#!/usr/bin/env bash
# install/nightscout-install.sh — Nightscout
...
header_info "Nightscout"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Nightscout"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/nightscout-install.sh"
...
echo ""
echo -e "${GR}Nightscout installation complete!${NC}"
echo ""
