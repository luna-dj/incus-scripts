#!/usr/bin/env bash
# install/yuvomi-install.sh — Yuvomi
...
msg_info "Loading upstream install script for Yuvomi"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/yuvomi-install.sh"
...
echo ""
echo -e "${GR}Yuvomi installation complete!${NC}"
echo ""
