#!/usr/bin/env bash
# install/pterodactyl-panel-install.sh — Pterodactyl Panel
...
header_info "Pterodactyl Panel"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Pterodactyl Panel"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/pterodactyl-panel-install.sh"
...
echo ""
echo -e "${GR}Pterodactyl Panel installation complete!${NC}"
echo ""
