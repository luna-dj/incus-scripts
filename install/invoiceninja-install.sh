#!/usr/bin/env bash
# install/invoiceninja-install.sh — Invoiceninja
...
header_info "Invoiceninja"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Invoiceninja"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/invoiceninja-install.sh"
...
echo ""
echo -e "${GR}Invoiceninja installation complete!${NC}"
echo ""
