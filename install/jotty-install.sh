#!/usr/bin/env bash
# install/jotty-install.sh — Jotty
...
msg_info "Loading upstream install script for Jotty"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/jotty-install.sh"
...
echo ""
echo -e "${GR}Jotty installation complete!${NC}"
echo ""
