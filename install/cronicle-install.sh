#!/usr/bin/env bash
# install/cronicle-install.sh — Cronicle
...
header_info "Cronicle"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Cronicle"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/cronicle-install.sh"
...
echo ""
echo -e "${GR}Cronicle installation complete!${NC}"
echo ""
