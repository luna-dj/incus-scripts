#!/usr/bin/env bash
# install/byparr-install.sh — Byparr
...
msg_info "Loading upstream install script for Byparr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/byparr-install.sh"
...
echo ""
echo -e "${GR}Byparr installation complete!${NC}"
echo ""
