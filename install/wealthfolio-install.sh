#!/usr/bin/env bash
# install/wealthfolio-install.sh — Wealthfolio
...
header_info "Wealthfolio"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Wealthfolio"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/wealthfolio-install.sh"
...
echo ""
echo -e "${GR}Wealthfolio installation complete!${NC}"
echo ""
