#!/usr/bin/env bash
# install/kiwix-install.sh — Kiwix
...
msg_info "Loading upstream install script for Kiwix"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/kiwix-install.sh"
...
echo ""
echo -e "${GR}Kiwix installation complete!${NC}"
echo ""
