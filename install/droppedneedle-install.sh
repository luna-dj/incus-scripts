#!/usr/bin/env bash
# install/droppedneedle-install.sh — Droppedneedle
...
header_info "Droppedneedle"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Droppedneedle"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/droppedneedle-install.sh"
...
echo ""
echo -e "${GR}Droppedneedle installation complete!${NC}"
echo ""
