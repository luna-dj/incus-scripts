#!/usr/bin/env bash
# install/checkmate-install.sh — Checkmate
...
header_info "Checkmate"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Checkmate"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/checkmate-install.sh"
...
echo ""
echo -e "${GR}Checkmate installation complete!${NC}"
echo ""
