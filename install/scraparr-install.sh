#!/usr/bin/env bash
# install/scraparr-install.sh — Scraparr
...
header_info "Scraparr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Scraparr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/scraparr-install.sh"
...
echo ""
echo -e "${GR}Scraparr installation complete!${NC}"
echo ""
