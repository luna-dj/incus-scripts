#!/usr/bin/env bash
# install/jackett-install.sh — Jackett
...
msg_info "Loading upstream install script for Jackett"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/jackett-install.sh"
...
echo ""
echo -e "${GR}Jackett installation complete!${NC}"
echo ""
