#!/usr/bin/env bash
# install/qbit-manage-install.sh — Qbit Manage
...
header_info "Qbit Manage"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Qbit Manage"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/qbit-manage-install.sh"
...
echo ""
echo -e "${GR}Qbit Manage installation complete!${NC}"
echo ""
