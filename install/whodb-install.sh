#!/usr/bin/env bash
# install/whodb-install.sh — Whodb
...
msg_info "Loading upstream install script for Whodb"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/whodb-install.sh"
...
echo ""
echo -e "${GR}Whodb installation complete!${NC}"
echo ""
