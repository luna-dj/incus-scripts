#!/usr/bin/env bash
# install/mini-qr-install.sh — Mini Qr
...
msg_info "Loading upstream install script for Mini Qr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/mini-qr-install.sh"
...
echo ""
echo -e "${GR}Mini Qr installation complete!${NC}"
echo ""
