#!/usr/bin/env bash
# install/safebucket-install.sh — Safebucket
...
header_info "Safebucket"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Safebucket"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/safebucket-install.sh"
...
echo ""
echo -e "${GR}Safebucket installation complete!${NC}"
echo ""
