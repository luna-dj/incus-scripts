...
msg_info "Loading upstream install script for Kutt"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/kutt-install.sh"
...
echo ""
echo -e "${GR}Kutt installation complete!${NC}"
echo ""
