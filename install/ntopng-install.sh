#!/usr/bin/env bash
# install/ntopng-install.sh — Ntopng
...
msg_info "Loading upstream install script for Ntopng"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/ntopng-install.sh"
...
echo ""
echo -e "${GR}Ntopng installation complete!${NC}"
echo ""
