#!/usr/bin/env bash
# install/jupyternotebook-install.sh — Jupyternotebook
...
header_info "Jupyternotebook"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Jupyternotebook"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/jupyternotebook-install.sh"
...
echo ""
echo -e "${GR}Jupyternotebook installation complete!${NC}"
echo ""
