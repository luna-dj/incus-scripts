#!/usr/bin/env bash
# install/unpackerr-install.sh — Unpackerr
...
header_info "Unpackerr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Unpackerr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/unpackerr-install.sh"
...
echo ""
echo -e "${GR}Unpackerr installation complete!${NC}"
echo ""
