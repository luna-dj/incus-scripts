#!/usr/bin/env bash
# install/flame-install.sh — Flame
...
msg_info "Loading upstream install script for Flame"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/flame-install.sh"
...
echo ""
echo -e "${GR}Flame installation complete!${NC}"
echo ""
