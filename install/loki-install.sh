...
msg_info "Loading upstream install script for Loki"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/loki-install.sh"
...
echo ""
echo -e "${GR}Loki installation complete!${NC}"
echo ""
