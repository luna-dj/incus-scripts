#!/usr/bin/env bash
# install/teamspeak-server-install.sh — Teamspeak Server
...
header_info "Teamspeak Server"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Teamspeak Server"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/teamspeak-server-install.sh"
...
echo ""
echo -e "${GR}Teamspeak Server installation complete!${NC}"
echo ""
