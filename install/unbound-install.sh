#!/usr/bin/env bash
# install/unbound-install.sh — Unbound
...
msg_info "Loading upstream install script for Unbound"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/unbound-install.sh"
...
echo ""
echo -e "${GR}Unbound installation complete!${NC}"
echo ""
