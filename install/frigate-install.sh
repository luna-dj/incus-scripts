#!/usr/bin/env bash
# install/frigate-install.sh — Frigate
...
msg_info "Loading upstream install script for Frigate"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/frigate-install.sh"
...
echo ""
echo -e "${GR}Frigate installation complete!${NC}"
echo ""
