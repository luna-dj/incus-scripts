#!/usr/bin/env bash
# install/gramps-web-install.sh — Gramps Web
...
header_info "Gramps Web"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Gramps Web"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/gramps-web-install.sh"
...
echo ""
echo -e "${GR}Gramps Web installation complete!${NC}"
echo ""
