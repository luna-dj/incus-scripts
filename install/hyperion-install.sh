#!/usr/bin/env bash
# install/hyperion-install.sh — Hyperion
...
header_info "Hyperion"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Hyperion"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/hyperion-install.sh"
...
echo ""
echo -e "${GR}Hyperion installation complete!${NC}"
echo ""
