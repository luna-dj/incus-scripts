#!/usr/bin/env bash
# install/rabbitmq-install.sh — Rabbitmq
...
header_info "Rabbitmq"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Rabbitmq"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/rabbitmq-install.sh"
...
echo ""
echo -e "${GR}Rabbitmq installation complete!${NC}"
echo ""
