#!/usr/bin/env bash
# install/yamtrack-install.sh — Yamtrack
...
header_info "Yamtrack"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Yamtrack"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/yamtrack-install.sh"
...
echo ""
echo -e "${GR}Yamtrack installation complete!${NC}"
echo ""
