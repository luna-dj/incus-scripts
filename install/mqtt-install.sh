...
msg_info "Loading upstream install script for Mqtt"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/mqtt-install.sh"
...
echo ""
echo -e "${GR}Mqtt installation complete!${NC}"
echo ""
