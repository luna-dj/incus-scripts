#!/usr/bin/env bash
# install/feishin-install.sh — Feishin
...
msg_info "Loading upstream install script for Feishin"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/feishin-install.sh"
...
echo ""
echo -e "${GR}Feishin installation complete!${NC}"
echo ""
