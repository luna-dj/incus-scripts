#!/usr/bin/env bash
# install/papra-install.sh — Papra
...
msg_info "Loading upstream install script for Papra"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/papra-install.sh"
...
echo ""
echo -e "${GR}Papra installation complete!${NC}"
echo ""
