#!/usr/bin/env bash
# install/alpine-garage-install.sh — Alpine Garage
...
header_info "Alpine Garage"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Garage"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-garage-install.sh"
...
echo ""
echo -e "${GR}Alpine Garage installation complete!${NC}"
echo ""
