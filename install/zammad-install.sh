#!/usr/bin/env bash
# install/zammad-install.sh — Zammad
...
msg_info "Loading upstream install script for Zammad"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/zammad-install.sh"
...
echo ""
echo -e "${GR}Zammad installation complete!${NC}"
echo ""
