#!/usr/bin/env bash
# install/donetick-install.sh — Donetick
...
header_info "Donetick"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Donetick"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/donetick-install.sh"
...
echo ""
echo -e "${GR}Donetick installation complete!${NC}"
echo ""
