#!/usr/bin/env bash
# install/budget-board-install.sh — Budget Board
...
header_info "Budget Board"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Budget Board"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/budget-board-install.sh"
...
echo ""
echo -e "${GR}Budget Board installation complete!${NC}"
echo ""
