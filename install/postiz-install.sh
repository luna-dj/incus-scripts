#!/usr/bin/env bash
# install/postiz-install.sh — Postiz
...
msg_info "Loading upstream install script for Postiz"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/postiz-install.sh"
...
echo ""
echo -e "${GR}Postiz installation complete!${NC}"
echo ""
