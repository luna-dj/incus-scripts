#!/usr/bin/env bash
# install/tracktor-install.sh — Tracktor
...
header_info "Tracktor"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Tracktor"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/tracktor-install.sh"
...
echo ""
echo -e "${GR}Tracktor installation complete!${NC}"
echo ""
