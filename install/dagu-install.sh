...
msg_info "Loading upstream install script for Dagu"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/dagu-install.sh"
...
echo ""
echo -e "${GR}Dagu installation complete!${NC}"
echo ""
