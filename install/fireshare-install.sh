#!/usr/bin/env bash
# install/fireshare-install.sh — Fireshare
...
header_info "Fireshare"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Fireshare"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/fireshare-install.sh"
...
echo ""
echo -e "${GR}Fireshare installation complete!${NC}"
echo ""
