#!/usr/bin/env bash
# install/limesurvey-install.sh — Limesurvey
...
header_info "Limesurvey"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Limesurvey"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/limesurvey-install.sh"
...
echo ""
echo -e "${GR}Limesurvey installation complete!${NC}"
echo ""
