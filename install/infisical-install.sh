#!/usr/bin/env bash
# install/infisical-install.sh — Infisical
...
header_info "Infisical"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Infisical"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/infisical-install.sh"
...
echo ""
echo -e "${GR}Infisical installation complete!${NC}"
echo ""
