#!/usr/bin/env bash
# install/coder-code-server-install.sh — Coder Code Server (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Coder Code Server addon)"
  setup_docker
  msg_ok "Docker installed"
fi

msg_info "Loading upstream addon script for Coder Code Server"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/coder-code-server.sh"
...
echo ""
echo -e "${GR}Coder Code Server installation complete!${NC}"
echo ""
