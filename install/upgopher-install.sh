#!/usr/bin/env bash
# install/upgopher-install.sh — Upgopher
...
header_info "Upgopher"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Upgopher"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/upgopher-install.sh"
...
echo ""
echo -e "${GR}Upgopher installation complete!${NC}"
echo ""
