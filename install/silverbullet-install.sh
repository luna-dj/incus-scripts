#!/usr/bin/env bash
# install/silverbullet-install.sh — Silverbullet
...
header_info "Silverbullet"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Silverbullet"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/silverbullet-install.sh"
...
echo ""
echo -e "${GR}Silverbullet installation complete!${NC}"
echo ""
