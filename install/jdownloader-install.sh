#!/usr/bin/env bash
# install/jdownloader-install.sh — Jdownloader
...
header_info "Jdownloader"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Jdownloader"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/jdownloader-install.sh"
...
echo ""
echo -e "${GR}Jdownloader installation complete!${NC}"
echo ""
