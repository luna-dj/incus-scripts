#!/usr/bin/env bash
# install/trilium-install.sh — Trilium
...
msg_info "Loading upstream install script for Trilium"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/trilium-install.sh"
...
echo ""
echo -e "${GR}Trilium installation complete!${NC}"
echo ""
