#!/usr/bin/env bash
# install/cleanuparr-install.sh — Cleanuparr
...
header_info "Cleanuparr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Cleanuparr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/cleanuparr-install.sh"
...
echo ""
echo -e "${GR}Cleanuparr installation complete!${NC}"
echo ""
