#!/usr/bin/env bash
# install/opengist-install.sh — Opengist
...
header_info "Opengist"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Opengist"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/opengist-install.sh"
...
echo ""
echo -e "${GR}Opengist installation complete!${NC}"
echo ""
