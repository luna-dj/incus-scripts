#!/usr/bin/env bash
# install/wazuh-install.sh — Wazuh
...
msg_info "Loading upstream install script for Wazuh"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/wazuh-install.sh"
...
echo ""
echo -e "${GR}Wazuh installation complete!${NC}"
echo ""
