#!/usr/bin/env bash
# install/scanopy-install.sh — Scanopy
...
msg_info "Loading upstream install script for Scanopy"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/scanopy-install.sh"
...
echo ""
echo -e "${GR}Scanopy installation complete!${NC}"
echo ""
