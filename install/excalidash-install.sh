#!/usr/bin/env bash
# install/excalidash-install.sh — Excalidash
...
header_info "Excalidash"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Excalidash"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/excalidash-install.sh"
...
echo ""
echo -e "${GR}Excalidash installation complete!${NC}"
echo ""
