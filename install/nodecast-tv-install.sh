#!/usr/bin/env bash
# install/nodecast-tv-install.sh — Nodecast Tv
...
header_info "Nodecast Tv"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Nodecast Tv"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/nodecast-tv-install.sh"
...
echo ""
echo -e "${GR}Nodecast Tv installation complete!${NC}"
echo ""
