#!/usr/bin/env bash
# install/notifiarr-install.sh — Notifiarr
...
header_info "Notifiarr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Notifiarr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/notifiarr-install.sh"
...
echo ""
echo -e "${GR}Notifiarr installation complete!${NC}"
echo ""
