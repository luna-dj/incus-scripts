#!/usr/bin/env bash
# install/securo-install.sh — Securo
...
msg_info "Loading upstream install script for Securo"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/securo-install.sh"
...
echo ""
echo -e "${GR}Securo installation complete!${NC}"
echo ""
