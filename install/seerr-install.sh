#!/usr/bin/env bash
# install/seerr-install.sh — Seerr
...
msg_info "Loading upstream install script for Seerr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/seerr-install.sh"
...
echo ""
echo -e "${GR}Seerr installation complete!${NC}"
echo ""
