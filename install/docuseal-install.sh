#!/usr/bin/env bash
# install/docuseal-install.sh — Docuseal
...
header_info "Docuseal"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Docuseal"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/docuseal-install.sh"
...
echo ""
echo -e "${GR}Docuseal installation complete!${NC}"
echo ""
