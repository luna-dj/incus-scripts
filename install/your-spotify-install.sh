#!/usr/bin/env bash
# install/your-spotify-install.sh — Your Spotify
...
header_info "Your Spotify"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Your Spotify"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/your-spotify-install.sh"
...
echo ""
echo -e "${GR}Your Spotify installation complete!${NC}"
echo ""
