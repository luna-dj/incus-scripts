#!/usr/bin/env bash
# install/minio-install.sh — Minio
...
msg_info "Loading upstream install script for Minio"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/minio-install.sh"
...
echo ""
echo -e "${GR}Minio installation complete!${NC}"
echo ""
