#!/usr/bin/env bash
# install/nxwitness-install.sh — Nxwitness
...
header_info "Nxwitness"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Nxwitness"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/nxwitness-install.sh"
...
echo ""
echo -e "${GR}Nxwitness installation complete!${NC}"
echo ""
