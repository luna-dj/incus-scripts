#!/usr/bin/env bash
# install/paperless-ngx-install.sh — Paperless Ngx
...
header_info "Paperless Ngx"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Paperless Ngx"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/paperless-ngx-install.sh"
...
echo ""
echo -e "${GR}Paperless Ngx installation complete!${NC}"
echo ""
