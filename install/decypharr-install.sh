#!/usr/bin/env bash
# install/decypharr-install.sh — Decypharr
...
header_info "Decypharr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Decypharr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/decypharr-install.sh"
...
echo ""
echo -e "${GR}Decypharr installation complete!${NC}"
echo ""
