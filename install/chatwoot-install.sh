#!/usr/bin/env bash
# install/chatwoot-install.sh — Chatwoot
...
header_info "Chatwoot"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Chatwoot"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/chatwoot-install.sh"
...
echo ""
echo -e "${GR}Chatwoot installation complete!${NC}"
echo ""
