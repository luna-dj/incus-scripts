#!/usr/bin/env bash
# install/tinyauth-install.sh — Tinyauth
...
header_info "Tinyauth"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Tinyauth"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/tinyauth-install.sh"
...
echo ""
echo -e "${GR}Tinyauth installation complete!${NC}"
echo ""
