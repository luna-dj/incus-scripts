#!/usr/bin/env bash
# install/blocky-install.sh — Blocky
...
msg_info "Loading upstream install script for Blocky"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/blocky-install.sh"
...
echo ""
echo -e "${GR}Blocky installation complete!${NC}"
echo ""
