#!/usr/bin/env bash
# install/autocaliweb-install.sh — Autocaliweb
...
header_info "Autocaliweb"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Autocaliweb"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/autocaliweb-install.sh"
...
echo ""
echo -e "${GR}Autocaliweb installation complete!${NC}"
echo ""
