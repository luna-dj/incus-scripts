#!/usr/bin/env bash
# install/photoprism-install.sh — Photoprism
...
header_info "Photoprism"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Photoprism"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/photoprism-install.sh"
...
echo ""
echo -e "${GR}Photoprism installation complete!${NC}"
echo ""
