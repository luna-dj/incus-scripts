#!/usr/bin/env bash
# install/chevereto-install.sh — Chevereto
...
header_info "Chevereto"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Chevereto"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/chevereto-install.sh"
...
echo ""
echo -e "${GR}Chevereto installation complete!${NC}"
echo ""
