#!/usr/bin/env bash
# install/maintainerr-install.sh — Maintainerr
...
header_info "Maintainerr"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Maintainerr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/maintainerr-install.sh"
...
echo ""
echo -e "${GR}Maintainerr installation complete!${NC}"
echo ""
