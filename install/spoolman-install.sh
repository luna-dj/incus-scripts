#!/usr/bin/env bash
# install/spoolman-install.sh — Spoolman
...
header_info "Spoolman"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Spoolman"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/spoolman-install.sh"
...
echo ""
echo -e "${GR}Spoolman installation complete!${NC}"
echo ""
