#!/usr/bin/env bash
# install/qdrant-install.sh — Qdrant
...
msg_info "Loading upstream install script for Qdrant"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/qdrant-install.sh"
...
echo ""
echo -e "${GR}Qdrant installation complete!${NC}"
echo ""
