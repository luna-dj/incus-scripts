#!/usr/bin/env bash
# install/archivebox-install.sh — Archivebox
...
header_info "Archivebox"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Archivebox"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/archivebox-install.sh"
...
echo ""
echo -e "${GR}Archivebox installation complete!${NC}"
echo ""
