#!/usr/bin/env bash
# install/yt-dlp-webui-install.sh — Yt Dlp Webui
...
header_info "Yt Dlp Webui"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Yt Dlp Webui"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/yt-dlp-webui-install.sh"
...
echo ""
echo -e "${GR}Yt Dlp Webui installation complete!${NC}"
echo ""
