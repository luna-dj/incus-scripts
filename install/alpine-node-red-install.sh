#!/usr/bin/env bash
# install/alpine-node-red-install.sh — Alpine Node Red
...
header_info "Alpine Node Red"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Node Red"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-node-red-install.sh"
...
echo ""
echo -e "${GR}Alpine Node Red installation complete!${NC}"
echo ""
