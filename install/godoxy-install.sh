#!/usr/bin/env bash
# install/godoxy-install.sh — Godoxy
...
msg_info "Loading upstream install script for Godoxy"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/godoxy-install.sh"
...
echo ""
echo -e "${GR}Godoxy installation complete!${NC}"
echo ""
