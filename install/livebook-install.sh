#!/usr/bin/env bash
# install/livebook-install.sh — Livebook
...
header_info "Livebook"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Livebook"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/livebook-install.sh"
...
echo ""
echo -e "${GR}Livebook installation complete!${NC}"
echo ""
