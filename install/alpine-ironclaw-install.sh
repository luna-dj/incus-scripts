#!/usr/bin/env bash
# install/alpine-ironclaw-install.sh — Alpine Ironclaw
...
header_info "Alpine Ironclaw"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Ironclaw"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-ironclaw-install.sh"
...
echo ""
echo -e "${GR}Alpine Ironclaw installation complete!${NC}"
echo ""
