#!/usr/bin/env bash
# install/alpine-wakapi-install.sh — Alpine Wakapi
...
header_info "Alpine Wakapi"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Wakapi"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-wakapi-install.sh"
...
echo ""
echo -e "${GR}Alpine Wakapi installation complete!${NC}"
echo ""
