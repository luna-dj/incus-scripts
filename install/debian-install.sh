#!/usr/bin/env bash
# install/debian-install.sh — Debian
...
msg_info "Loading upstream install script for Debian"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/debian-install.sh"
...
echo ""
echo -e "${GR}Debian installation complete!${NC}"
echo ""
