#!/usr/bin/env bash
# install/alpine-borgbackup-server-install.sh — Alpine Borgbackup Server
...
header_info "Alpine Borgbackup Server"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Alpine Borgbackup Server"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-borgbackup-server-install.sh"
...
echo ""
echo -e "${GR}Alpine Borgbackup Server installation complete!${NC}"
echo ""
