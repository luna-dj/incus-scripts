#!/usr/bin/env bash
# install/pegaprox-install.sh — Pegaprox
...
header_info "Pegaprox"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Pegaprox"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/pegaprox-install.sh"
...
echo ""
echo -e "${GR}Pegaprox installation complete!${NC}"
echo ""
