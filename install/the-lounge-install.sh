#!/usr/bin/env bash
# install/the-lounge-install.sh — The Lounge
...
header_info "The Lounge"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for The Lounge"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/the-lounge-install.sh"
...
echo ""
echo -e "${GR}The Lounge installation complete!${NC}"
echo ""
