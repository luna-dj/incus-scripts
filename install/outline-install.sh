#!/usr/bin/env bash
# install/outline-install.sh — Outline
...
msg_info "Loading upstream install script for Outline"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/outline-install.sh"
...
echo ""
echo -e "${GR}Outline installation complete!${NC}"
echo ""
