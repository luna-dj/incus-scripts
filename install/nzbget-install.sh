#!/usr/bin/env bash
# install/nzbget-install.sh — Nzbget
...
msg_info "Loading upstream install script for Nzbget"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/nzbget-install.sh"
...
echo ""
echo -e "${GR}Nzbget installation complete!${NC}"
echo ""
