#!/usr/bin/env bash
# install/fmd-server-install.sh — Fmd Server
...
header_info "Fmd Server"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Fmd Server"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/fmd-server-install.sh"
...
echo ""
echo -e "${GR}Fmd Server installation complete!${NC}"
echo ""
