#!/usr/bin/env bash
# install/mediamanager-install.sh — Mediamanager
...
header_info "Mediamanager"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Mediamanager"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/mediamanager-install.sh"
...
echo ""
echo -e "${GR}Mediamanager installation complete!${NC}"
echo ""
