#!/usr/bin/env bash
# install/rockylinux-install.sh — Rockylinux
...
header_info "Rockylinux"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Rockylinux"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/rockylinux-install.sh"
...
echo ""
echo -e "${GR}Rockylinux installation complete!${NC}"
echo ""
