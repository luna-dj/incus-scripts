#!/usr/bin/env bash
# install/jellystat-install.sh — Jellystat (addon)
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Jellystat addon)"
  setup_docker
...
msg_info "Loading upstream addon script for Jellystat"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/jellystat.sh"
...
echo ""
echo -e "${GR}Jellystat installation complete!${NC}"
echo ""
