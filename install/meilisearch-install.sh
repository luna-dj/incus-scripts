#!/usr/bin/env bash
# install/meilisearch-install.sh — Meilisearch
...
header_info "Meilisearch"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Meilisearch"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/meilisearch-install.sh"
...
echo ""
echo -e "${GR}Meilisearch installation complete!${NC}"
echo ""
