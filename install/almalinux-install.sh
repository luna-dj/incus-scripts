#!/usr/bin/env bash
# install/almalinux-install.sh — Almalinux
...
header_info "Almalinux"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Almalinux"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/almalinux-install.sh"
...
echo ""
echo -e "${GR}Almalinux installation complete!${NC}"
echo ""
