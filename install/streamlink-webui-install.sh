#!/usr/bin/env bash
# install/streamlink-webui-install.sh — Streamlink Webui
...
header_info "Streamlink Webui"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Streamlink Webui"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/streamlink-webui-install.sh"
...
echo ""
echo -e "${GR}Streamlink Webui installation complete!${NC}"
echo ""
