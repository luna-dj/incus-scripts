#!/usr/bin/env bash
# install/telegraf-install.sh — Telegraf
...
header_info "Telegraf"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Telegraf"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/telegraf-install.sh"
...
echo ""
echo -e "${GR}Telegraf installation complete!${NC}"
echo ""
