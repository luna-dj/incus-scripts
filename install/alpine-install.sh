#!/usr/bin/env bash
# install/alpine-install.sh — Alpine
...
msg_info "Loading upstream install script for Alpine"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/alpine-install.sh"
...
echo ""
echo -e "${GR}Alpine installation complete!${NC}"
echo ""
