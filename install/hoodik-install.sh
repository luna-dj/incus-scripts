#!/usr/bin/env bash
# install/hoodik-install.sh — Hoodik
...
msg_info "Loading upstream install script for Hoodik"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/hoodik-install.sh"
...
echo ""
echo -e "${GR}Hoodik installation complete!${NC}"
echo ""
