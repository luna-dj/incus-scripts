#!/usr/bin/env bash
# install/stirling-pdf-install.sh — Stirling Pdf
...
header_info "Stirling Pdf"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Stirling Pdf"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/stirling-pdf-install.sh"
...
echo ""
echo -e "${GR}Stirling Pdf installation complete!${NC}"
echo ""
