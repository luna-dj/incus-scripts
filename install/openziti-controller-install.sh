#!/usr/bin/env bash
# install/openziti-controller-install.sh — Openziti Controller
...
header_info "Openziti Controller"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Openziti Controller"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/openziti-controller-install.sh"
...
echo ""
echo -e "${GR}Openziti Controller installation complete!${NC}"
echo ""
