#!/usr/bin/env bash
# install/filebrowser-quantum-install.sh — Filebrowser Quantum (addon)
...
header_info "Filebrowser Quantum"
...
if ! command -v docker &>/dev/null; then
  msg_info "Installing Docker (required for Filebrowser Quantum addon)"
  setup_docker
...
msg_info "Loading upstream addon script for Filebrowser Quantum"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/addon/filebrowser-quantum.sh"
...
echo ""
echo -e "${GR}Filebrowser Quantum installation complete!${NC}"
echo ""
