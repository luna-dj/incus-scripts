#!/usr/bin/env bash
# install/swizzin-install.sh — Swizzin
...
msg_info "Loading upstream install script for Swizzin"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/swizzin-install.sh"
...
echo ""
echo -e "${GR}Swizzin installation complete!${NC}"
echo ""
