#!/usr/bin/env bash
# install/dashy-install.sh — Dashy
...
msg_info "Loading upstream install script for Dashy"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/dashy-install.sh"
...
echo ""
echo -e "${GR}Dashy installation complete!${NC}"
echo ""
