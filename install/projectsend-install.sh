#!/usr/bin/env bash
# install/projectsend-install.sh — Projectsend
...
header_info "Projectsend"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Projectsend"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/projectsend-install.sh"
...
echo ""
echo -e "${GR}Projectsend installation complete!${NC}"
echo ""
