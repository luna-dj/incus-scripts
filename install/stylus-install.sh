#!/usr/bin/env bash
# install/stylus-install.sh — Stylus
...
msg_info "Loading upstream install script for Stylus"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/stylus-install.sh"
...
echo ""
echo -e "${GR}Stylus installation complete!${NC}"
echo ""
