#!/usr/bin/env bash
# install/tor-snowflake-install.sh — Tor Snowflake
...
header_info "Tor Snowflake"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Tor Snowflake"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/tor-snowflake-install.sh"
...
echo ""
echo -e "${GR}Tor Snowflake installation complete!${NC}"
echo ""
