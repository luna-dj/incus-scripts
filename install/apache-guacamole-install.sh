#!/usr/bin/env bash
# install/apache-guacamole-install.sh — Apache Guacamole
...
header_info "Apache Guacamole"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Apache Guacamole"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/apache-guacamole-install.sh"
...
echo ""
echo -e "${GR}Apache Guacamole installation complete!${NC}"
echo ""
