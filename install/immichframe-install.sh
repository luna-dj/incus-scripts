#!/usr/bin/env bash
# install/immichframe-install.sh — Immichframe
...
header_info "Immichframe"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Immichframe"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/immichframe-install.sh"
...
echo ""
echo -e "${GR}Immichframe installation complete!${NC}"
echo ""
