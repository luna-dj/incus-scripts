#!/usr/bin/env bash
# install/cockpit-install.sh — Cockpit
...
msg_info "Loading upstream install script for Cockpit"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/cockpit-install.sh"
...
echo ""
echo -e "${GR}Cockpit installation complete!${NC}"
echo ""
