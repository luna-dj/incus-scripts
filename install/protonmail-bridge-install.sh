#!/usr/bin/env bash
# install/protonmail-bridge-install.sh — Protonmail Bridge
...
header_info "Protonmail Bridge"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Protonmail Bridge"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/protonmail-bridge-install.sh"
...
echo ""
echo -e "${GR}Protonmail Bridge installation complete!${NC}"
echo ""
