#!/usr/bin/env bash
# install/lychee-install.sh — Lychee
...
msg_info "Loading upstream install script for Lychee"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/lychee-install.sh"
...
echo ""
echo -e "${GR}Lychee installation complete!${NC}"
echo ""
