#!/usr/bin/env bash
# install/affine-install.sh — Affine
...
msg_info "Loading upstream install script for Affine"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/affine-install.sh"
...
echo ""
echo -e "${GR}Affine installation complete!${NC}"
echo ""
