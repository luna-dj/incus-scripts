#!/usr/bin/env bash
# install/hammer-install.sh — Hammer
...
msg_info "Loading upstream install script for Hammer"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/hammer-install.sh"
...
echo ""
echo -e "${GR}Hammer installation complete!${NC}"
echo ""
