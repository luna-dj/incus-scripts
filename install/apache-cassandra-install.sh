#!/usr/bin/env bash
# install/apache-cassandra-install.sh — Apache Cassandra
...
header_info "Apache Cassandra"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Apache Cassandra"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/apache-cassandra-install.sh"
...
echo ""
echo -e "${GR}Apache Cassandra installation complete!${NC}"
echo ""
