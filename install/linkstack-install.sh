#!/usr/bin/env bash
# install/linkstack-install.sh — Linkstack
...
header_info "Linkstack"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Linkstack"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/linkstack-install.sh"
...
echo ""
echo -e "${GR}Linkstack installation complete!${NC}"
echo ""
