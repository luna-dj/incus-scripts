#!/usr/bin/env bash
# install/shelfmark-install.sh — Shelfmark
...
header_info "Shelfmark"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Shelfmark"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/shelfmark-install.sh"
...
echo ""
echo -e "${GR}Shelfmark installation complete!${NC}"
echo ""
