#!/usr/bin/env bash
# install/navidrome-install.sh — Navidrome
...
header_info "Navidrome"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Navidrome"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/navidrome-install.sh"
...
echo ""
echo -e "${GR}Navidrome installation complete!${NC}"
echo ""
