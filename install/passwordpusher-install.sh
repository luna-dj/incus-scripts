#!/usr/bin/env bash
# install/passwordpusher-install.sh — Passwordpusher
...
header_info "Passwordpusher"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Passwordpusher"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/passwordpusher-install.sh"
...
echo ""
echo -e "${GR}Passwordpusher installation complete!${NC}"
echo ""
