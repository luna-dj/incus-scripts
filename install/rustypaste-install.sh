...
msg_info "Loading upstream install script for Rustypaste"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/rustypaste-install.sh"
...
echo ""
echo -e "${GR}Rustypaste installation complete!${NC}"
echo ""
