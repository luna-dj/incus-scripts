#!/usr/bin/env bash
# install/revealjs-install.sh — Revealjs
...
header_info "Revealjs"
setting_up_container
network_check
update_os

msg_info "Loading upstream install script for Revealjs"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/revealjs-install.sh"
...
echo ""
echo -e "${GR}Revealjs installation complete!${NC}"
echo ""
