#!/usr/bin/env bash
# install/mongodb-install.sh — Mongodb
...
msg_info "Loading upstream install script for Mongodb"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/mongodb-install.sh"
...
echo ""
echo -e "${GR}Mongodb installation complete!${NC}"
echo ""
