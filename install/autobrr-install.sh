#!/usr/bin/env bash
# install/autobrr-install.sh — Autobrr
...
msg_info "Loading upstream install script for Autobrr"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/autobrr-install.sh"
...
echo ""
echo -e "${GR}Autobrr installation complete!${NC}"
echo ""
