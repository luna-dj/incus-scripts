#!/usr/bin/env bash
# install/haproxy-install.sh — Haproxy
...
msg_info "Loading upstream install script for Haproxy"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/haproxy-install.sh"
...
echo ""
echo -e "${GR}Haproxy installation complete!${NC}"
echo ""
