#!/usr/bin/env bash
# install/shlink-install.sh — Shlink
...
msg_info "Loading upstream install script for Shlink"
UPSTREAM_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/shlink-install.sh"
...
echo ""
echo -e "${GR}Shlink installation complete!${NC}"
echo ""
