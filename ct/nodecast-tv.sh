...
INSTALL_SCRIPT=$(curl -fsSL --http1.1 "https://codeberg.org/luna-dj/incus-scripts/raw/branch/main/install/nodecast-tv-install.sh" 2>/dev/null) || {
    log_error "Failed to fetch install script for nodecast-tv"
    exit 1
}
