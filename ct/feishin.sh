...
$(curl -fsSL "https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/install/feishin-install.sh")
SCRIPT
)
...
echo ""
echo -e "${GR}Feishin deployed on ${var_instance} (${IP})${NC}"
echo ""
